...
main(int argc, char *argv[])
{
  ...
  13:	c7 44 24 04 0d 08 00 	movl   $0x80d,0x4(%esp)
  1a:	00 
  ...
  51:	c7 44 24 04 20 08 00 	movl   $0x820,0x4(%esp)
  58:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 399:	0f b6 92 3b 08 00 00 	movzbl 0x83b(%edx),%edx
  }while((x /= base) != 0);
 ...
 40e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 52f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 531:	b8 34 08 00 00       	mov    $0x834,%eax
...
free(void *ap)
{
 ...
 5f1:	a1 38 0b 00 00       	mov    0xb38,%eax
{
 ...
 637:	89 10                	mov    %edx,(%eax)
  freep = p;
 639:	a3 38 0b 00 00       	mov    %eax,0xb38
}
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 ...
 65f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 662:	a3 38 0b 00 00       	mov    %eax,0xb38
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 1d 38 0b 00 00    	mov    0xb38,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6c9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6cb:	3b 15 38 0b 00 00    	cmp    0xb38,%edx
 ...
 6fd:	e8 ee fe ff ff       	call   5f0 <free>
  return freep;
 702:	8b 15 38 0b 00 00    	mov    0xb38,%edx
 ...
 724:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 727:	89 15 38 0b 00 00    	mov    %edx,0xb38
      return (void*)(p + 1);
 ...
 73c:	eb e9                	jmp    727 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 73e:	c7 05 38 0b 00 00 3c 	movl   $0xb3c,0xb38
 745:	0b 00 00 
    base.s.size = 0;
 748:	ba 3c 0b 00 00       	mov    $0xb3c,%edx
    base.s.ptr = freep = prevp = &base;
 74d:	c7 05 3c 0b 00 00 3c 	movl   $0xb3c,0xb3c
 754:	0b 00 00 
    base.s.size = 0;
 757:	c7 05 40 0b 00 00 00 	movl   $0x0,0xb40
 75e:	00 00 00 
...
void thread_create(void *(*start_routine)(void*), void *arg){
 ...
 777:	c7 04 24 00 20 00 00 	movl   $0x2000,(%esp)
 77e:	e8 fd fe ff ff       	call   680 <malloc>
 783:	89 c3                	mov    %eax,%ebx
  if((uint)stack % PGSIZE)
 785:	25 ff 0f 00 00       	and    $0xfff,%eax
 78a:	74 08                	je     794 <thread_create+0x24>
      stack = stack + (PGSIZE - (uint)stack % PGSIZE);
 78c:	29 c3                	sub    %eax,%ebx
 78e:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  int id;
  id = clone(stack, PGSIZE*2);
 794:	c7 44 24 04 00 20 00 	movl   $0x2000,0x4(%esp)
 79b:	00 
 79c:	89 1c 24             	mov    %ebx,(%esp)
 79f:	e8 a6 fb ff ff       	call   34a <clone>
  // id == 0 means this process is a thread
  if(id == 0){
 7a4:	85 c0                	test   %eax,%eax
 7a6:	74 06                	je     7ae <thread_create+0x3e>
    (*start_routine)(arg);
    free(stack);
    exit();
  }
 ...
 7b4:	ff 55 08             	call   *0x8(%ebp)
    free(stack);
 7b7:	89 1c 24             	mov    %ebx,(%esp)
 7ba:	e8 31 fe ff ff       	call   5f0 <free>
    exit();
 7bf:	e8 ce fa ff ff       	call   292 <exit>
...
xchg(volatile uint *addr, uint newval)
{
 ...
 7f7:	75 f7                	jne    7f0 <lock_acquire+0x10>
}
 7f9:	5d                   	pop    %ebp
 7fa:	c3                   	ret    
 7fb:	90                   	nop

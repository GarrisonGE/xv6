...
main(void)
{
  ...
  11:	00 
  12:	c7 04 24 ad 08 00 00 	movl   $0x8ad,(%esp)
  ...
  40:	c7 44 24 04 b5 08 00 	movl   $0x8b5,0x4(%esp)
  47:	00 
  ...
  74:	74 ca                	je     40 <main+0x40>
      printf(1, "zombie!\n");
  76:	c7 44 24 04 f4 08 00 	movl   $0x8f4,0x4(%esp)
  7d:	00 
  7e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  85:	e8 16 04 00 00       	call   4a0 <printf>
  8a:	eb dc                	jmp    68 <main+0x68>
      printf(1, "init: fork failed\n");
  8c:	c7 44 24 04 c8 08 00 	movl   $0x8c8,0x4(%esp)
  93:	00 
  ...
  a0:	e8 8d 02 00 00       	call   332 <exit>
      exec("sh", argv);
  a5:	c7 44 24 04 04 0c 00 	movl   $0xc04,0x4(%esp)
  ac:	00 
  ad:	c7 04 24 db 08 00 00 	movl   $0x8db,(%esp)
  b4:	e8 b1 02 00 00       	call   36a <exec>
      printf(1, "init: exec sh failed\n");
  b9:	c7 44 24 04 de 08 00 	movl   $0x8de,0x4(%esp)
  c0:	00 
  ...
  e1:	00 
  e2:	c7 04 24 ad 08 00 00 	movl   $0x8ad,(%esp)
  e9:	e8 8c 02 00 00       	call   37a <mknod>
    open("console", O_RDWR);
  ee:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  f5:	00 
  f6:	c7 04 24 ad 08 00 00 	movl   $0x8ad,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 439:	0f b6 92 04 09 00 00 	movzbl 0x904(%edx),%edx
  }while((x /= base) != 0);
 ...
 4ae:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 5cf:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 5d1:	b8 fd 08 00 00       	mov    $0x8fd,%eax
 ...
 691:	a1 0c 0c 00 00       	mov    0xc0c,%eax
{
 ...
 6d7:	89 10                	mov    %edx,(%eax)
  freep = p;
 6d9:	a3 0c 0c 00 00       	mov    %eax,0xc0c
}
 6de:	5b                   	pop    %ebx
 6df:	5e                   	pop    %esi
 6e0:	5f                   	pop    %edi
 ...
 6ff:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 702:	a3 0c 0c 00 00       	mov    %eax,0xc0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 1d 0c 0c 00 00    	mov    0xc0c,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 769:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 76b:	3b 15 0c 0c 00 00    	cmp    0xc0c,%edx
 ...
 79d:	e8 ee fe ff ff       	call   690 <free>
  return freep;
 7a2:	8b 15 0c 0c 00 00    	mov    0xc0c,%edx
 ...
 7c4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7c7:	89 15 0c 0c 00 00    	mov    %edx,0xc0c
      return (void*)(p + 1);
 ...
 7dc:	eb e9                	jmp    7c7 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 7de:	c7 05 0c 0c 00 00 10 	movl   $0xc10,0xc0c
 7e5:	0c 00 00 
    base.s.size = 0;
 7e8:	ba 10 0c 00 00       	mov    $0xc10,%edx
    base.s.ptr = freep = prevp = &base;
 7ed:	c7 05 10 0c 00 00 10 	movl   $0xc10,0xc10
 7f4:	0c 00 00 
    base.s.size = 0;
 7f7:	c7 05 14 0c 00 00 00 	movl   $0x0,0xc14
 7fe:	00 00 00 
...
void thread_create(void *(*start_routine)(void*), void *arg){
 ...
 817:	c7 04 24 00 20 00 00 	movl   $0x2000,(%esp)
 81e:	e8 fd fe ff ff       	call   720 <malloc>
 823:	89 c3                	mov    %eax,%ebx
  if((uint)stack % PGSIZE)
 825:	25 ff 0f 00 00       	and    $0xfff,%eax
 82a:	74 08                	je     834 <thread_create+0x24>
      stack = stack + (PGSIZE - (uint)stack % PGSIZE);
 82c:	29 c3                	sub    %eax,%ebx
 82e:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  int id;
  id = clone(stack, PGSIZE*2);
 834:	c7 44 24 04 00 20 00 	movl   $0x2000,0x4(%esp)
 83b:	00 
 83c:	89 1c 24             	mov    %ebx,(%esp)
 83f:	e8 a6 fb ff ff       	call   3ea <clone>
  // id == 0 means this process is a thread
  if(id == 0){
 844:	85 c0                	test   %eax,%eax
 846:	74 06                	je     84e <thread_create+0x3e>
    (*start_routine)(arg);
    free(stack);
    exit();
  }
 ...
 854:	ff 55 08             	call   *0x8(%ebp)
    free(stack);
 857:	89 1c 24             	mov    %ebx,(%esp)
 85a:	e8 31 fe ff ff       	call   690 <free>
    exit();
 85f:	e8 ce fa ff ff       	call   332 <exit>
...
void lock_release(struct lock_t *lk){
 ...
 8a8:	f0 87 02             	lock xchg %eax,(%edx)
  xchg(&lk->locked, 0);
 8ab:	5d                   	pop    %ebp
 8ac:	c3                   	ret    

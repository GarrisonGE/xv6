   ...
   5:	be 01 00 00 00       	mov    $0x1,%esi
{
  ...
  60:	c7 44 24 04 50 09 00 	movl   $0x950,0x4(%esp)
  67:	00 
  ...
  78:	e8 35 03 00 00       	call   3b2 <exit>
    wc(0, "");
  7d:	c7 44 24 04 42 09 00 	movl   $0x942,0x4(%esp)
  84:	00 
  ...
  a8:	31 db                	xor    %ebx,%ebx
{
  ...
  ca:	00 
  cb:	c7 44 24 04 c0 0c 00 	movl   $0xcc0,0x4(%esp)
  d2:	00 
  ...
  f9:	31 c9                	xor    %ecx,%ecx
      if(strchr(" \r\t\n\v", buf[i]))
  fb:	c7 04 24 2d 09 00 00 	movl   $0x92d,(%esp)
        l++;
 ...
 140:	c7 44 24 04 43 09 00 	movl   $0x943,0x4(%esp)
 147:	00 
 ...
 16e:	c7 44 24 04 33 09 00 	movl   $0x933,0x4(%esp)
 175:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4b9:	0f b6 92 6b 09 00 00 	movzbl 0x96b(%edx),%edx
  }while((x /= base) != 0);
 ...
 52e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 64f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 651:	b8 64 09 00 00       	mov    $0x964,%eax
...
free(void *ap)
{
 ...
 711:	a1 a0 0c 00 00       	mov    0xca0,%eax
{
 ...
 757:	89 10                	mov    %edx,(%eax)
  freep = p;
 759:	a3 a0 0c 00 00       	mov    %eax,0xca0
}
 75e:	5b                   	pop    %ebx
 75f:	5e                   	pop    %esi
 760:	5f                   	pop    %edi
 ...
 77f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 782:	a3 a0 0c 00 00       	mov    %eax,0xca0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ac:	8b 1d a0 0c 00 00    	mov    0xca0,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7e9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 7eb:	3b 15 a0 0c 00 00    	cmp    0xca0,%edx
 ...
 81d:	e8 ee fe ff ff       	call   710 <free>
  return freep;
 822:	8b 15 a0 0c 00 00    	mov    0xca0,%edx
 ...
 844:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 847:	89 15 a0 0c 00 00    	mov    %edx,0xca0
      return (void*)(p + 1);
 ...
 85c:	eb e9                	jmp    847 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 85e:	c7 05 a0 0c 00 00 a4 	movl   $0xca4,0xca0
 865:	0c 00 00 
    base.s.size = 0;
 868:	ba a4 0c 00 00       	mov    $0xca4,%edx
    base.s.ptr = freep = prevp = &base;
 86d:	c7 05 a4 0c 00 00 a4 	movl   $0xca4,0xca4
 874:	0c 00 00 
    base.s.size = 0;
 877:	c7 05 a8 0c 00 00 00 	movl   $0x0,0xca8
 87e:	00 00 00 
...
void thread_create(void *(*start_routine)(void*), void *arg){
 ...
 897:	c7 04 24 00 20 00 00 	movl   $0x2000,(%esp)
 89e:	e8 fd fe ff ff       	call   7a0 <malloc>
 8a3:	89 c3                	mov    %eax,%ebx
  if((uint)stack % PGSIZE)
 8a5:	25 ff 0f 00 00       	and    $0xfff,%eax
 8aa:	74 08                	je     8b4 <thread_create+0x24>
      stack = stack + (PGSIZE - (uint)stack % PGSIZE);
 8ac:	29 c3                	sub    %eax,%ebx
 8ae:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  int id;
  id = clone(stack, PGSIZE*2);
 8b4:	c7 44 24 04 00 20 00 	movl   $0x2000,0x4(%esp)
 8bb:	00 
 8bc:	89 1c 24             	mov    %ebx,(%esp)
 8bf:	e8 a6 fb ff ff       	call   46a <clone>
  // id == 0 means this process is a thread
  if(id == 0){
 8c4:	85 c0                	test   %eax,%eax
 8c6:	74 06                	je     8ce <thread_create+0x3e>
    (*start_routine)(arg);
    free(stack);
    exit();
  }
 ...
 8d4:	ff 55 08             	call   *0x8(%ebp)
    free(stack);
 8d7:	89 1c 24             	mov    %ebx,(%esp)
 8da:	e8 31 fe ff ff       	call   710 <free>
    exit();
 8df:	e8 ce fa ff ff       	call   3b2 <exit>
...
void lock_release(struct lock_t *lk){
 ...
 928:	f0 87 02             	lock xchg %eax,(%edx)
  xchg(&lk->locked, 0);
 92b:	5d                   	pop    %ebp
 92c:	c3                   	ret    

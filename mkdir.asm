   ...
   5:	be 01 00 00 00       	mov    $0x1,%esi
{
  ...
  3f:	c7 44 24 04 34 08 00 	movl   $0x834,0x4(%esp)
  46:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a9:	0f b6 92 57 08 00 00 	movzbl 0x857(%edx),%edx
  }while((x /= base) != 0);
 ...
 41e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 53f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 541:	b8 50 08 00 00       	mov    $0x850,%eax
...
free(void *ap)
{
 ...
 601:	a1 5c 0b 00 00       	mov    0xb5c,%eax
{
 ...
 647:	89 10                	mov    %edx,(%eax)
  freep = p;
 649:	a3 5c 0b 00 00       	mov    %eax,0xb5c
}
 64e:	5b                   	pop    %ebx
 64f:	5e                   	pop    %esi
 650:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 1d 5c 0b 00 00    	mov    0xb5c,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6d9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6db:	3b 15 5c 0b 00 00    	cmp    0xb5c,%edx
 ...
 70d:	e8 ee fe ff ff       	call   600 <free>
  return freep;
 712:	8b 15 5c 0b 00 00    	mov    0xb5c,%edx
 ...
 734:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 737:	89 15 5c 0b 00 00    	mov    %edx,0xb5c
      return (void*)(p + 1);
 ...
 74c:	eb e9                	jmp    737 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 74e:	c7 05 5c 0b 00 00 60 	movl   $0xb60,0xb5c
 755:	0b 00 00 
    base.s.size = 0;
 758:	ba 60 0b 00 00       	mov    $0xb60,%edx
    base.s.ptr = freep = prevp = &base;
 75d:	c7 05 60 0b 00 00 60 	movl   $0xb60,0xb60
 764:	0b 00 00 
    base.s.size = 0;
 767:	c7 05 64 0b 00 00 00 	movl   $0x0,0xb64
 76e:	00 00 00 

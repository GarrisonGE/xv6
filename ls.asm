   ...
   6:	bb 01 00 00 00       	mov    $0x1,%ebx
{
  ...
  32:	e8 6b 05 00 00       	call   5a2 <exit>
    ls(".");
  37:	c7 04 24 65 0b 00 00 	movl   $0xb65,(%esp)
...
00000050 <fmtname>:
{
  ...
  98:	c7 04 24 d8 0e 00 00 	movl   $0xed8,(%esp)
  ...
  return buf;
  b3:	bb d8 0e 00 00       	mov    $0xed8,%ebx
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
  ...
  d1:	00 
  d2:	05 d8 0e 00 00       	add    $0xed8,%eax
...
000000f0 <ls>:
{
 ...
 171:	00 
 172:	c7 44 24 04 45 0b 00 	movl   $0xb45,0x4(%esp)
 179:	00 
 ...
 2aa:	c7 44 24 04 45 0b 00 	movl   $0xb45,0x4(%esp)
 2b1:	00 
 ...
 2e4:	c7 44 24 04 1d 0b 00 	movl   $0xb1d,0x4(%esp)
 2eb:	00 
 ...
 308:	c7 44 24 04 52 0b 00 	movl   $0xb52,0x4(%esp)
 30f:	00 
 ...
 32c:	c7 44 24 04 31 0b 00 	movl   $0xb31,0x4(%esp)
 333:	00 
 ...
 35a:	c7 44 24 04 31 0b 00 	movl   $0xb31,0x4(%esp)
 361:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6a9:	0f b6 92 6e 0b 00 00 	movzbl 0xb6e(%edx),%edx
  }while((x /= base) != 0);
 ...
 71e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 83f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 841:	b8 67 0b 00 00       	mov    $0xb67,%eax
 ...
 901:	a1 e8 0e 00 00       	mov    0xee8,%eax
{
 ...
 947:	89 10                	mov    %edx,(%eax)
  freep = p;
 949:	a3 e8 0e 00 00       	mov    %eax,0xee8
}
 94e:	5b                   	pop    %ebx
 94f:	5e                   	pop    %esi
 950:	5f                   	pop    %edi
 ...
 96f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 972:	a3 e8 0e 00 00       	mov    %eax,0xee8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 999:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 99c:	8b 1d e8 0e 00 00    	mov    0xee8,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9d9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 9db:	3b 15 e8 0e 00 00    	cmp    0xee8,%edx
 ...
 a0d:	e8 ee fe ff ff       	call   900 <free>
  return freep;
 a12:	8b 15 e8 0e 00 00    	mov    0xee8,%edx
 ...
 a34:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a37:	89 15 e8 0e 00 00    	mov    %edx,0xee8
      return (void*)(p + 1);
 ...
 a4c:	eb e9                	jmp    a37 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 a4e:	c7 05 e8 0e 00 00 ec 	movl   $0xeec,0xee8
 a55:	0e 00 00 
    base.s.size = 0;
 a58:	ba ec 0e 00 00       	mov    $0xeec,%edx
    base.s.ptr = freep = prevp = &base;
 a5d:	c7 05 ec 0e 00 00 ec 	movl   $0xeec,0xeec
 a64:	0e 00 00 
    base.s.size = 0;
 a67:	c7 05 f0 0e 00 00 00 	movl   $0x0,0xef0
 a6e:	00 00 00 
...
void thread_create(void *(*start_routine)(void*), void *arg){
 ...
 a87:	c7 04 24 00 20 00 00 	movl   $0x2000,(%esp)
 a8e:	e8 fd fe ff ff       	call   990 <malloc>
 a93:	89 c3                	mov    %eax,%ebx
  if((uint)stack % PGSIZE)
 a95:	25 ff 0f 00 00       	and    $0xfff,%eax
 a9a:	74 08                	je     aa4 <thread_create+0x24>
      stack = stack + (PGSIZE - (uint)stack % PGSIZE);
 a9c:	29 c3                	sub    %eax,%ebx
 a9e:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  int id;
  id = clone(stack, PGSIZE*2);
 aa4:	c7 44 24 04 00 20 00 	movl   $0x2000,0x4(%esp)
 aab:	00 
 aac:	89 1c 24             	mov    %ebx,(%esp)
 aaf:	e8 a6 fb ff ff       	call   65a <clone>
  // id == 0 means this process is a thread
  if(id == 0){
 ab4:	85 c0                	test   %eax,%eax
 ab6:	74 06                	je     abe <thread_create+0x3e>
    (*start_routine)(arg);
    free(stack);
    exit();
  }
 ...
 ac4:	ff 55 08             	call   *0x8(%ebp)
    free(stack);
 ac7:	89 1c 24             	mov    %ebx,(%esp)
 aca:	e8 31 fe ff ff       	call   900 <free>
    exit();
 acf:	e8 ce fa ff ff       	call   5a2 <exit>
...
void lock_release(struct lock_t *lk){
 ...
 b18:	f0 87 02             	lock xchg %eax,(%edx)
  xchg(&lk->locked, 0);
 b1b:	5d                   	pop    %ebp
 b1c:	c3                   	ret    

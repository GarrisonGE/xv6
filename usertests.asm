...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
       9:	c7 44 24 04 0e 52 00 	movl   $0x520e,0x4(%esp)
      10:	00 
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      24:	00 
      25:	c7 04 24 22 52 00 00 	movl   $0x5222,(%esp)
      2c:	e8 b1 3c 00 00       	call   3ce2 <open>
      31:	85 c0                	test   %eax,%eax
      33:	78 19                	js     4e <main+0x4e>
    printf(1, "already ran user tests -- rebuild fs.img\n");
      35:	c7 44 24 04 8c 59 00 	movl   $0x598c,0x4(%esp)
      3c:	00 
  ...
  close(open("usertests.ran", O_CREATE));
      ...
      55:	00 
      56:	c7 04 24 22 52 00 00 	movl   $0x5222,(%esp)
...
00000130 <iputtest>:
{
  ...
  printf(stdout, "iput test ok\n");
    ...
    printf(stdout, "mkdir failed\n");
     1a6:	a1 24 63 00 00       	mov    0x6324,%eax
     1ab:	c7 44 24 04 20 42 00 	movl   $0x4220,0x4(%esp)
     1b2:	00 
    ...
    printf(stdout, "chdir / failed\n");
     1c0:	a1 24 63 00 00       	mov    0x6324,%eax
     1c5:	c7 44 24 04 6b 42 00 	movl   $0x426b,0x4(%esp)
     1cc:	00 
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     1da:	a1 24 63 00 00       	mov    0x6324,%eax
     1df:	c7 44 24 04 4f 42 00 	movl   $0x424f,0x4(%esp)
     1e6:	00 
    ...
    printf(stdout, "chdir iputdir failed\n");
     1f4:	a1 24 63 00 00       	mov    0x6324,%eax
     1f9:	c7 44 24 04 2e 42 00 	movl   $0x422e,0x4(%esp)
     200:	00 
...
00000210 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     216:	a1 24 63 00 00       	mov    0x6324,%eax
     21b:	c7 44 24 04 7b 42 00 	movl   $0x427b,0x4(%esp)
     222:	00 
  ...
  printf(stdout, "exitiput test ok\n");
     275:	a1 24 63 00 00       	mov    0x6324,%eax
     27a:	c7 44 24 04 9e 42 00 	movl   $0x429e,0x4(%esp)
     281:	00 
     ...
     28c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      printf(stdout, "unlink ../iputdir failed\n");
     290:	a1 24 63 00 00       	mov    0x6324,%eax
     295:	c7 44 24 04 4f 42 00 	movl   $0x424f,0x4(%esp)
     29c:	00 
    ...
    printf(stdout, "fork failed\n");
     2aa:	a1 24 63 00 00       	mov    0x6324,%eax
     2af:	c7 44 24 04 61 51 00 	movl   $0x5161,0x4(%esp)
     2b6:	00 
    ...
    exit();
     ...
     2c4:	a1 24 63 00 00       	mov    0x6324,%eax
     2c9:	c7 44 24 04 8a 42 00 	movl   $0x428a,0x4(%esp)
     2d0:	00 
     ...
     2d9:	e8 c4 39 00 00       	call   3ca2 <exit>
      printf(stdout, "mkdir failed\n");
     2de:	a1 24 63 00 00       	mov    0x6324,%eax
     2e3:	c7 44 24 04 20 42 00 	movl   $0x4220,0x4(%esp)
     2ea:	00 
...
00000300 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     306:	a1 24 63 00 00       	mov    0x6324,%eax
     30b:	c7 44 24 04 b0 42 00 	movl   $0x42b0,0x4(%esp)
     312:	00 
     313:	89 04 24             	mov    %eax,(%esp)
     316:	e8 f5 3a 00 00       	call   3e10 <printf>
  if(mkdir("oidir") < 0){
     31b:	c7 04 24 bf 42 00 00 	movl   $0x42bf,(%esp)
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     349:	00 
     34a:	c7 04 24 bf 42 00 00 	movl   $0x42bf,(%esp)
     351:	e8 8c 39 00 00       	call   3ce2 <open>
    if(fd >= 0){
     356:	85 c0                	test   %eax,%eax
     358:	78 6e                	js     3c8 <openiputtest+0xc8>
      printf(stdout, "open directory for write succeeded\n");
     35a:	a1 24 63 00 00       	mov    0x6324,%eax
     35f:	c7 44 24 04 44 52 00 	movl   $0x5244,0x4(%esp)
     366:	00 
  ...
  if(unlink("oidir") != 0){
     384:	c7 04 24 bf 42 00 00 	movl   $0x42bf,(%esp)
  ...
  printf(stdout, "openiput test ok\n");
     399:	a1 24 63 00 00       	mov    0x6324,%eax
     39e:	c7 44 24 04 e8 42 00 	movl   $0x42e8,0x4(%esp)
     3a5:	00 
    ...
    printf(stdout, "unlink failed\n");
     3b0:	a1 24 63 00 00       	mov    0x6324,%eax
     3b5:	c7 44 24 04 d9 42 00 	movl   $0x42d9,0x4(%esp)
     3bc:	00 
    ...
    printf(stdout, "mkdir oidir failed\n");
     3cd:	a1 24 63 00 00       	mov    0x6324,%eax
     3d2:	c7 44 24 04 c5 42 00 	movl   $0x42c5,0x4(%esp)
     3d9:	00 
    ...
    printf(stdout, "fork failed\n");
     3e7:	a1 24 63 00 00       	mov    0x6324,%eax
     3ec:	c7 44 24 04 61 51 00 	movl   $0x5161,0x4(%esp)
     3f3:	00 
...
00000410 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     416:	a1 24 63 00 00       	mov    0x6324,%eax
     41b:	c7 44 24 04 fa 42 00 	movl   $0x42fa,0x4(%esp)
     422:	00 
  ...
  fd = open("echo", 0);
     ...
     432:	00 
     433:	c7 04 24 05 43 00 00 	movl   $0x4305,(%esp)
  ...
  fd = open("doesnotexist", 0);
     ...
     452:	00 
     453:	c7 04 24 1d 43 00 00 	movl   $0x431d,(%esp)
     45a:	e8 83 38 00 00       	call   3ce2 <open>
  if(fd >= 0){
     45f:	85 c0                	test   %eax,%eax
     461:	79 31                	jns    494 <opentest+0x84>
  printf(stdout, "open test ok\n");
     463:	a1 24 63 00 00       	mov    0x6324,%eax
     468:	c7 44 24 04 48 43 00 	movl   $0x4348,0x4(%esp)
     46f:	00 
    ...
    printf(stdout, "open echo failed!\n");
     47a:	a1 24 63 00 00       	mov    0x6324,%eax
     47f:	c7 44 24 04 0a 43 00 	movl   $0x430a,0x4(%esp)
     486:	00 
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     494:	a1 24 63 00 00       	mov    0x6324,%eax
     499:	c7 44 24 04 2a 43 00 	movl   $0x432a,0x4(%esp)
     4a0:	00 
...
000004b0 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     4b8:	a1 24 63 00 00       	mov    0x6324,%eax
     4bd:	c7 44 24 04 56 43 00 	movl   $0x4356,0x4(%esp)
     4c4:	00 
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4d4:	00 
     4d5:	c7 04 24 67 43 00 00 	movl   $0x4367,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     4eb:	a1 24 63 00 00       	mov    0x6324,%eax
  for(i = 0; i < 100; i++){
     4f0:	31 db                	xor    %ebx,%ebx
    printf(stdout, "creat small succeeded; ok\n");
     4f2:	c7 44 24 04 6d 43 00 	movl   $0x436d,0x4(%esp)
     4f9:	00 
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     50f:	00 
     510:	c7 44 24 04 a4 43 00 	movl   $0x43a4,0x4(%esp)
     517:	00 
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     530:	00 
     531:	c7 44 24 04 af 43 00 	movl   $0x43af,0x4(%esp)
     538:	00 
  ...
  printf(stdout, "writes ok\n");
     552:	a1 24 63 00 00       	mov    0x6324,%eax
     557:	c7 44 24 04 ba 43 00 	movl   $0x43ba,0x4(%esp)
     55e:	00 
  ...
  fd = open("small", O_RDONLY);
     ...
     576:	00 
     577:	c7 04 24 67 43 00 00 	movl   $0x4367,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     58d:	a1 24 63 00 00       	mov    0x6324,%eax
     592:	c7 44 24 04 c5 43 00 	movl   $0x43c5,0x4(%esp)
     599:	00 
  ...
  i = read(fd, buf, 2000);
     ...
     5a9:	00 
     5aa:	c7 44 24 04 00 8b 00 	movl   $0x8b00,0x4(%esp)
     5b1:	00 
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     5c5:	a1 24 63 00 00       	mov    0x6324,%eax
     5ca:	c7 44 24 04 f9 43 00 	movl   $0x43f9,0x4(%esp)
     5d1:	00 
  ...
  if(unlink("small") < 0){
     5e2:	c7 04 24 67 43 00 00 	movl   $0x4367,(%esp)
     5e9:	e8 04 37 00 00       	call   3cf2 <unlink>
     5ee:	85 c0                	test   %eax,%eax
     5f0:	0f 88 8c 00 00 00    	js     682 <writetest+0x1d2>
  printf(stdout, "small file test ok\n");
     5f6:	a1 24 63 00 00       	mov    0x6324,%eax
     5fb:	c7 44 24 04 21 44 00 	movl   $0x4421,0x4(%esp)
     602:	00 
     ...
     612:	a1 24 63 00 00       	mov    0x6324,%eax
     617:	89 5c 24 08          	mov    %ebx,0x8(%esp)
     61b:	c7 44 24 04 68 52 00 	movl   $0x5268,0x4(%esp)
     622:	00 
     ...
     630:	a1 24 63 00 00       	mov    0x6324,%eax
     635:	89 5c 24 08          	mov    %ebx,0x8(%esp)
     639:	c7 44 24 04 8c 52 00 	movl   $0x528c,0x4(%esp)
     640:	00 
    ...
    printf(stdout, "error: open small failed!\n");
     64e:	a1 24 63 00 00       	mov    0x6324,%eax
     653:	c7 44 24 04 de 43 00 	movl   $0x43de,0x4(%esp)
     65a:	00 
    ...
    printf(stdout, "read failed\n");
     668:	a1 24 63 00 00       	mov    0x6324,%eax
     66d:	c7 44 24 04 25 47 00 	movl   $0x4725,0x4(%esp)
     674:	00 
    ...
    printf(stdout, "unlink small failed\n");
     682:	a1 24 63 00 00       	mov    0x6324,%eax
     687:	c7 44 24 04 0c 44 00 	movl   $0x440c,0x4(%esp)
     68e:	00 
    ...
    printf(stdout, "error: creat small failed!\n");
     69c:	a1 24 63 00 00       	mov    0x6324,%eax
     6a1:	c7 44 24 04 88 43 00 	movl   $0x4388,0x4(%esp)
     6a8:	00 
...
000006c0 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     6c8:	a1 24 63 00 00       	mov    0x6324,%eax
     6cd:	c7 44 24 04 35 44 00 	movl   $0x4435,0x4(%esp)
     6d4:	00 
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     6e4:	00 
     6e5:	c7 04 24 af 44 00 00 	movl   $0x44af,(%esp)
  ...
  if(fd < 0){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     707:	00 
     708:	c7 44 24 04 00 8b 00 	movl   $0x8b00,0x4(%esp)
     70f:	00 
     710:	89 34 24             	mov    %esi,(%esp)
    ((int*)buf)[0] = i;
     713:	89 1d 00 8b 00 00    	mov    %ebx,0x8b00
    if(write(fd, buf, 512) != 512){
  ...
  fd = open("big", O_RDONLY);
     ...
     743:	00 
     744:	c7 04 24 af 44 00 00 	movl   $0x44af,(%esp)
  ...
  if(fd < 0){
    ...
    if(((int*)buf)[0] != n){
     76b:	a1 00 8b 00 00       	mov    0x8b00,%eax
    ...
    i = read(fd, buf, 512);
     ...
     782:	00 
     783:	c7 44 24 04 00 8b 00 	movl   $0x8b00,0x4(%esp)
     78a:	00 
  ...
  if(unlink("big") < 0){
     7ab:	c7 04 24 af 44 00 00 	movl   $0x44af,(%esp)
     7b2:	e8 3b 35 00 00       	call   3cf2 <unlink>
     7b7:	85 c0                	test   %eax,%eax
     7b9:	0f 88 d0 00 00 00    	js     88f <writetest1+0x1cf>
  printf(stdout, "big files ok\n");
     7bf:	a1 24 63 00 00       	mov    0x6324,%eax
     7c4:	c7 44 24 04 d6 44 00 	movl   $0x44d6,0x4(%esp)
     7cb:	00 
     ...
     7db:	a1 24 63 00 00       	mov    0x6324,%eax
     7e0:	89 5c 24 08          	mov    %ebx,0x8(%esp)
     7e4:	c7 44 24 04 5f 44 00 	movl   $0x445f,0x4(%esp)
     7eb:	00 
     ...
     7fd:	a1 24 63 00 00       	mov    0x6324,%eax
     802:	89 5c 24 08          	mov    %ebx,0x8(%esp)
     806:	c7 44 24 04 b0 52 00 	movl   $0x52b0,0x4(%esp)
     80d:	00 
     ...
     81f:	a1 24 63 00 00       	mov    0x6324,%eax
     824:	c7 44 24 04 b3 44 00 	movl   $0x44b3,0x4(%esp)
     82b:	00 
     ...
     839:	a1 24 63 00 00       	mov    0x6324,%eax
     83e:	c7 44 24 08 8b 00 00 	movl   $0x8b,0x8(%esp)
     845:	00 
     846:	c7 44 24 04 96 44 00 	movl   $0x4496,0x4(%esp)
     84d:	00 
    ...
    printf(stdout, "error: open big failed!\n");
     85b:	a1 24 63 00 00       	mov    0x6324,%eax
     860:	c7 44 24 04 7d 44 00 	movl   $0x447d,0x4(%esp)
     867:	00 
    ...
    printf(stdout, "error: creat big failed!\n");
     875:	a1 24 63 00 00       	mov    0x6324,%eax
    ...
    printf(stdout, "unlink big failed\n");
     88f:	a1 24 63 00 00       	mov    0x6324,%eax
     894:	c7 44 24 04 c3 44 00 	movl   $0x44c3,0x4(%esp)
     89b:	00 
     ...
     8b4:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     8bc:	a1 24 63 00 00       	mov    0x6324,%eax
     8c1:	c7 44 24 04 d0 52 00 	movl   $0x52d0,0x4(%esp)
     8c8:	00 
     8c9:	89 04 24             	mov    %eax,(%esp)
     8cc:	e8 3f 35 00 00       	call   3e10 <printf>
  name[0] = 'a';
     8d1:	c6 05 00 ab 00 00 61 	movb   $0x61,0xab00
  name[2] = '\0';
     8d8:	c6 05 02 ab 00 00 00 	movb   $0x0,0xab02
     8df:	90                   	nop
    fd = open(name, O_CREATE|O_RDWR);
     8e0:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     8e7:	00 
     8e8:	c7 04 24 00 ab 00 00 	movl   $0xab00,(%esp)
    name[1] = '0' + i;
     8ef:	88 1d 01 ab 00 00    	mov    %bl,0xab01
  ...
  name[0] = 'a';
     90a:	c6 05 00 ab 00 00 61 	movb   $0x61,0xab00
  name[2] = '\0';
     911:	bb 30 00 00 00       	mov    $0x30,%ebx
     916:	c6 05 02 ab 00 00 00 	movb   $0x0,0xab02
     91d:	8d 76 00             	lea    0x0(%esi),%esi
    name[1] = '0' + i;
     920:	88 1d 01 ab 00 00    	mov    %bl,0xab01
     926:	83 c3 01             	add    $0x1,%ebx
    unlink(name);
     929:	c7 04 24 00 ab 00 00 	movl   $0xab00,(%esp)
     930:	e8 bd 33 00 00       	call   3cf2 <unlink>
  for(i = 0; i < 52; i++){
     935:	80 fb 64             	cmp    $0x64,%bl
     938:	75 e6                	jne    920 <createtest+0x70>
  printf(stdout, "many creates, followed by unlink; ok\n");
     93a:	a1 24 63 00 00       	mov    0x6324,%eax
     93f:	c7 44 24 04 f8 52 00 	movl   $0x52f8,0x4(%esp)
     946:	00 
...
00000960 <dirtest>:
{
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     9d5:	c3                   	ret    
    printf(stdout, "mkdir failed\n");
     9d6:	a1 24 63 00 00       	mov    0x6324,%eax
     9db:	c7 44 24 04 20 42 00 	movl   $0x4220,0x4(%esp)
     9e2:	00 
    ...
    printf(stdout, "unlink dir0 failed\n");
     9f0:	a1 24 63 00 00       	mov    0x6324,%eax
     9f5:	c7 44 24 04 19 45 00 	movl   $0x4519,0x4(%esp)
     9fc:	00 
    ...
    printf(stdout, "chdir .. failed\n");
     a0a:	a1 24 63 00 00       	mov    0x6324,%eax
     a0f:	c7 44 24 04 08 45 00 	movl   $0x4508,0x4(%esp)
     a16:	00 
    ...
    printf(stdout, "chdir dir0 failed\n");
     a24:	a1 24 63 00 00       	mov    0x6324,%eax
     a29:	c7 44 24 04 f5 44 00 	movl   $0x44f5,0x4(%esp)
     a30:	00 
...
00000a40 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     a46:	a1 24 63 00 00       	mov    0x6324,%eax
     a4b:	c7 44 24 04 3c 45 00 	movl   $0x453c,0x4(%esp)
     a52:	00 
     a53:	89 04 24             	mov    %eax,(%esp)
     a56:	e8 b5 33 00 00       	call   3e10 <printf>
  if(exec("echo", echoargv) < 0){
     a5b:	c7 44 24 04 28 63 00 	movl   $0x6328,0x4(%esp)
     a62:	00 
     a63:	c7 04 24 05 43 00 00 	movl   $0x4305,(%esp)
    ...
    printf(stdout, "exec echo failed\n");
     a75:	a1 24 63 00 00       	mov    0x6324,%eax
     a7a:	c7 44 24 04 47 45 00 	movl   $0x4547,0x4(%esp)
     a81:	00 
...
00000a90 <pipe1>:
{
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ae0:	c7 44 24 04 00 8b 00 	movl   $0x8b00,0x4(%esp)
     ae7:	00 
     ...
     b0a:	38 9c 0b 00 8b 00 00 	cmp    %bl,0x8b00(%ebx,%ecx,1)
     ...
     b31:	c7 44 24 04 76 45 00 	movl   $0x4576,0x4(%esp)
     b38:	00 
     ...
     b5a:	89 f0                	mov    %esi,%eax
{
     ...
     b66:	66 90                	xchg   %ax,%ax
        buf[i] = seq++;
     b68:	88 9c 18 00 8b 00 00 	mov    %bl,0x8b00(%eax,%ebx,1)
     ...
     b82:	00 
     b83:	c7 44 24 04 00 8b 00 	movl   $0x8b00,0x4(%esp)
     b8a:	00 
  ...
  printf(1, "pipe1 ok\n");
     bc4:	c7 44 24 04 9b 45 00 	movl   $0x459b,0x4(%esp)
     bcb:	00 
     ...
     be0:	c7 44 24 04 84 45 00 	movl   $0x4584,0x4(%esp)
     be7:	00 
    ...
    printf(1, "pipe() failed\n");
     bfa:	c7 44 24 04 59 45 00 	movl   $0x4559,0x4(%esp)
     c01:	00 
    ...
    printf(1, "fork() failed\n");
     c13:	c7 44 24 04 a5 45 00 	movl   $0x45a5,0x4(%esp)
     c1a:	00 
    ...
    exit();
     ...
     c2c:	c7 44 24 04 68 45 00 	movl   $0x4568,0x4(%esp)
     c33:	00 
...
00000c50 <preempt>:
{
  ...
  printf(1, "preempt: ");
     c59:	c7 44 24 04 b4 45 00 	movl   $0x45b4,0x4(%esp)
     c60:	00 
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     cb8:	00 
     cb9:	c7 44 24 04 79 4b 00 	movl   $0x4b79,0x4(%esp)
     cc0:	00 
     ...
     cce:	c7 44 24 04 be 45 00 	movl   $0x45be,0x4(%esp)
     cd5:	00 
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     d04:	00 
     d05:	c7 44 24 04 00 8b 00 	movl   $0x8b00,0x4(%esp)
     d0c:	00 
    ...
    printf(1, "preempt read error");
     d1a:	c7 44 24 04 d2 45 00 	movl   $0x45d2,0x4(%esp)
     d21:	00 
  ...
  printf(1, "kill... ");
     d41:	c7 44 24 04 e5 45 00 	movl   $0x45e5,0x4(%esp)
     d48:	00 
  ...
  printf(1, "wait... ");
     d6d:	c7 44 24 04 ee 45 00 	movl   $0x45ee,0x4(%esp)
     d74:	00 
  ...
  printf(1, "preempt ok\n");
     d95:	c7 44 24 04 f7 45 00 	movl   $0x45f7,0x4(%esp)
     d9c:	00 
...
00000db0 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ddb:	79 e3                	jns    dc0 <exitwait+0x10>
      printf(1, "fork failed\n");
     ddd:	c7 44 24 04 61 51 00 	movl   $0x5161,0x4(%esp)
     de4:	00 
     ...
     df8:	c7 44 24 04 03 46 00 	movl   $0x4603,0x4(%esp)
     dff:	00 
  ...
  printf(1, "exitwait ok\n");
     e18:	c7 44 24 04 13 46 00 	movl   $0x4613,0x4(%esp)
     e1f:	00 
...
00000e40 <mem>:
{
  ...
  printf(1, "mem test\n");
     e49:	c7 44 24 04 20 46 00 	movl   $0x4620,0x4(%esp)
     e50:	00 
  ...
  if((pid = fork()) == 0){
    ...
    printf(1, "mem ok\n");
     ec0:	c7 44 24 04 44 46 00 	movl   $0x4644,0x4(%esp)
     ec7:	00 
    ...
    wait();
     ...
     ef0:	c7 44 24 04 2a 46 00 	movl   $0x462a,0x4(%esp)
     ef7:	00 
...
00000f20 <sharedfd>:
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     fb6:	c7 44 24 04 4c 53 00 	movl   $0x534c,0x4(%esp)
     fbd:	00 
  ...
  fd = open("sharedfd", 0);
     ...
     fe9:	00 
     fea:	c7 04 24 5b 46 00 00 	movl   $0x465b,(%esp)
  ...
  unlink("sharedfd");
    106c:	c7 04 24 5b 46 00 00 	movl   $0x465b,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    108b:	c7 44 24 04 64 46 00 	movl   $0x4664,0x4(%esp)
    1092:	00 
    ...
    10a7:	c7 44 24 04 20 53 00 	movl   $0x5320,0x4(%esp)
    10ae:	00 
    ...
    10c3:	c7 44 24 04 6c 53 00 	movl   $0x536c,0x4(%esp)
    10ca:	00 
    ...
    10e7:	c7 44 24 04 71 46 00 	movl   $0x4671,0x4(%esp)
    10ee:	00 
...
00001100 <fourfiles>:
{
  ...
  printf(1, "fourfiles test\n");
    1105:	be 86 46 00 00       	mov    $0x4686,%esi
{
    110a:	53                   	push   %ebx
  for(pi = 0; pi < 4; pi++){
    110b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    1110:	c7 44 24 04 8c 46 00 	movl   $0x468c,0x4(%esp)
    1117:	00 
    1118:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  char *names[] = { "f0", "f1", "f2", "f3" };
    111f:	c7 45 d8 86 46 00 00 	movl   $0x4686,-0x28(%ebp)
    1126:	c7 45 dc cf 47 00 00 	movl   $0x47cf,-0x24(%ebp)
    112d:	c7 45 e0 d3 47 00 00 	movl   $0x47d3,-0x20(%ebp)
    1134:	c7 45 e4 89 46 00 00 	movl   $0x4689,-0x1c(%ebp)
  printf(1, "fourfiles test\n");
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1182:	c7 45 d4 86 46 00 00 	movl   $0x4686,-0x2c(%ebp)
    fd = open(fname, 0);
    ...
    11a7:	00 
    11a8:	c7 44 24 04 00 8b 00 	movl   $0x8b00,0x4(%esp)
    11af:	00 
    ...
    11be:	66 90                	xchg   %ax,%ax
        if(buf[j] != '0'+i){
    11c0:	0f be 8a 00 8b 00 00 	movsbl 0x8b00(%edx),%ecx
  ...
  printf(1, "fourfiles ok\n");
    11fa:	c7 44 24 04 ca 46 00 	movl   $0x46ca,0x4(%esp)
    1201:	00 
    ...
    1221:	e9 63 ff ff ff       	jmp    1189 <fourfiles+0x89>
          printf(1, "wrong char\n");
    1226:	c7 44 24 04 ad 46 00 	movl   $0x46ad,0x4(%esp)
    122d:	00 
    ...
    126c:	00 
    126d:	c7 04 24 00 8b 00 00 	movl   $0x8b00,(%esp)
    ...
    128c:	00 
    128d:	c7 44 24 04 00 8b 00 	movl   $0x8b00,0x4(%esp)
    1294:	00 
    ...
    12a8:	c7 44 24 04 9c 46 00 	movl   $0x469c,0x4(%esp)
    12af:	00 
    ...
    12c5:	c7 44 24 04 b9 46 00 	movl   $0x46b9,0x4(%esp)
    12cc:	00 
    ...
    12d9:	e8 c4 29 00 00       	call   3ca2 <exit>
      printf(1, "fork failed\n");
    12de:	c7 44 24 04 61 51 00 	movl   $0x5161,0x4(%esp)
    12e5:	00 
    ...
    12f7:	c7 44 24 04 27 49 00 	movl   $0x4927,0x4(%esp)
    12fe:	00 
    ...
    1316:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    131b:	c7 44 24 04 d8 46 00 	movl   $0x46d8,0x4(%esp)
    1322:	00 
  ...
  printf(1, "createdelete ok\n");
    1415:	c7 44 24 04 eb 46 00 	movl   $0x46eb,0x4(%esp)
    141c:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    14bc:	c7 44 24 04 d9 42 00 	movl   $0x42d9,0x4(%esp)
    14c3:	00 
    ...
    14dc:	c7 44 24 04 98 53 00 	movl   $0x5398,0x4(%esp)
    14e3:	00 
    ...
    14f0:	e8 ad 27 00 00       	call   3ca2 <exit>
          printf(1, "create failed\n");
    14f5:	c7 44 24 04 27 49 00 	movl   $0x4927,0x4(%esp)
    14fc:	00 
    ...
    1509:	e8 94 27 00 00       	call   3ca2 <exit>
      printf(1, "fork failed\n");
    150e:	c7 44 24 04 61 51 00 	movl   $0x5161,0x4(%esp)
    1515:	00 
    ...
    152b:	c7 44 24 04 bc 53 00 	movl   $0x53bc,0x4(%esp)
    1532:	00 
...
00001550 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    1558:	c7 44 24 04 fc 46 00 	movl   $0x46fc,0x4(%esp)
    155f:	00 
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1573:	00 
    1574:	c7 04 24 0d 47 00 00 	movl   $0x470d,(%esp)
  ...
  write(fd, "hello", 5);
    ...
    1591:	00 
    1592:	c7 44 24 04 32 47 00 	movl   $0x4732,0x4(%esp)
    1599:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    15b1:	00 
    15b2:	c7 04 24 0d 47 00 00 	movl   $0x470d,(%esp)
  ...
  if(unlink("unlinkread") != 0){
    15c8:	c7 04 24 0d 47 00 00 	movl   $0x470d,(%esp)
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    15e3:	00 
    15e4:	c7 04 24 0d 47 00 00 	movl   $0x470d,(%esp)
    15eb:	e8 f2 26 00 00       	call   3ce2 <open>
  write(fd1, "yyy", 3);
    15f0:	c7 44 24 08 03 00 00 	movl   $0x3,0x8(%esp)
    15f7:	00 
    15f8:	c7 44 24 04 6a 47 00 	movl   $0x476a,0x4(%esp)
    15ff:	00 
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1619:	00 
    161a:	c7 44 24 04 00 8b 00 	movl   $0x8b00,0x4(%esp)
    1621:	00 
  ...
  if(buf[0] != 'h'){
    1633:	80 3d 00 8b 00 00 68 	cmpb   $0x68,0x8b00
    163a:	75 7e                	jne    16ba <unlinkread+0x16a>
  if(write(fd, buf, 10) != 10){
    163c:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    1643:	00 
    1644:	c7 44 24 04 00 8b 00 	movl   $0x8b00,0x4(%esp)
    164b:	00 
  ...
  unlink("unlinkread");
    1661:	c7 04 24 0d 47 00 00 	movl   $0x470d,(%esp)
    1668:	e8 85 26 00 00       	call   3cf2 <unlink>
  printf(1, "unlinkread ok\n");
    166d:	c7 44 24 04 b5 47 00 	movl   $0x47b5,0x4(%esp)
    1674:	00 
    ...
    1688:	c7 44 24 04 18 47 00 	movl   $0x4718,0x4(%esp)
    168f:	00 
    ...
    16a1:	c7 44 24 04 9c 47 00 	movl   $0x479c,0x4(%esp)
    16a8:	00 
    ...
    16ba:	c7 44 24 04 85 47 00 	movl   $0x4785,0x4(%esp)
    16c1:	00 
    ...
    16d3:	c7 44 24 04 6e 47 00 	movl   $0x476e,0x4(%esp)
    16da:	00 
    ...
    16ec:	c7 44 24 04 50 47 00 	movl   $0x4750,0x4(%esp)
    16f3:	00 
    ...
    1705:	c7 44 24 04 38 47 00 	movl   $0x4738,0x4(%esp)
    170c:	00 
...
00001720 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1778:	00 
    1779:	c7 44 24 04 32 47 00 	movl   $0x4732,0x4(%esp)
    1780:	00 
  ...
  fd = open("lf2", 0);
    ...
    17e5:	00 
    17e6:	c7 04 24 d2 47 00 00 	movl   $0x47d2,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1803:	00 
    1804:	c7 44 24 04 00 8b 00 	movl   $0x8b00,0x4(%esp)
    180b:	00 
  ...
  if(link("lf2", "lf2") >= 0){
    1825:	c7 44 24 04 d2 47 00 	movl   $0x47d2,0x4(%esp)
    182c:	00 
    182d:	c7 04 24 d2 47 00 00 	movl   $0x47d2,(%esp)
    1834:	e8 c9 24 00 00       	call   3d02 <link>
    1839:	85 c0                	test   %eax,%eax
    183b:	0f 89 a1 00 00 00    	jns    18e2 <linktest+0x1c2>
  unlink("lf2");
    1841:	c7 04 24 d2 47 00 00 	movl   $0x47d2,(%esp)
    1848:	e8 a5 24 00 00       	call   3cf2 <unlink>
  if(link("lf2", "lf1") >= 0){
    184d:	c7 44 24 04 ce 47 00 	movl   $0x47ce,0x4(%esp)
    1854:	00 
    1855:	c7 04 24 d2 47 00 00 	movl   $0x47d2,(%esp)
    185c:	e8 a1 24 00 00       	call   3d02 <link>
    1861:	85 c0                	test   %eax,%eax
    1863:	79 64                	jns    18c9 <linktest+0x1a9>
  if(link(".", "lf1") >= 0){
    1865:	c7 44 24 04 ce 47 00 	movl   $0x47ce,0x4(%esp)
    186c:	00 
    186d:	c7 04 24 96 4a 00 00 	movl   $0x4a96,(%esp)
    1874:	e8 89 24 00 00       	call   3d02 <link>
    1879:	85 c0                	test   %eax,%eax
    187b:	79 33                	jns    18b0 <linktest+0x190>
  printf(1, "linktest ok\n");
    187d:	c7 44 24 04 6c 48 00 	movl   $0x486c,0x4(%esp)
    1884:	00 
    ...
    1897:	c7 44 24 04 d6 47 00 	movl   $0x47d6,0x4(%esp)
    189e:	00 
    ...
    18b0:	c7 44 24 04 50 48 00 	movl   $0x4850,0x4(%esp)
    18b7:	00 
    ...
    18c9:	c7 44 24 04 04 54 00 	movl   $0x5404,0x4(%esp)
    18d0:	00 
    ...
    18e2:	c7 44 24 04 32 48 00 	movl   $0x4832,0x4(%esp)
    18e9:	00 
    ...
    18fb:	c7 44 24 04 21 48 00 	movl   $0x4821,0x4(%esp)
    1902:	00 
    ...
    1914:	c7 44 24 04 10 48 00 	movl   $0x4810,0x4(%esp)
    191b:	00 
    ...
    192d:	c7 44 24 04 dc 53 00 	movl   $0x53dc,0x4(%esp)
    1934:	00 
    ...
    1946:	c7 44 24 04 fb 47 00 	movl   $0x47fb,0x4(%esp)
    194d:	00 
    ...
    195f:	c7 44 24 04 e9 47 00 	movl   $0x47e9,0x4(%esp)
    1966:	00 
    ...
    1985:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "concreate test\n");
    198b:	c7 44 24 04 79 48 00 	movl   $0x4879,0x4(%esp)
    1992:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    1a34:	c7 04 24 89 48 00 00 	movl   $0x4889,(%esp)
  ...
  for(i = 0; i < 40; i++){
    1a4c:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    1a4f:	c7 04 24 89 48 00 00 	movl   $0x4889,(%esp)
  ...
  fd = open(".", 0);
    ...
    1a8d:	00 
    1a8e:	c7 04 24 96 4a 00 00 	movl   $0x4a96,(%esp)
  ...
  printf(1, "concreate ok\n");
    1bf0:	c7 44 24 04 de 48 00 	movl   $0x48de,0x4(%esp)
    1bf7:	00 
    ...
    1c0b:	c3                   	ret    
      printf(1, "fork failed\n");
    1c0c:	c7 44 24 04 61 51 00 	movl   $0x5161,0x4(%esp)
    1c13:	00 
    ...
    1c29:	c7 44 24 04 8c 48 00 	movl   $0x488c,0x4(%esp)
    1c30:	00 
    ...
    1c49:	c7 44 24 04 a8 48 00 	movl   $0x48a8,0x4(%esp)
    1c50:	00 
    ...
    1c62:	c7 44 24 04 28 54 00 	movl   $0x5428,0x4(%esp)
    1c69:	00 
    ...
    1c82:	c7 44 24 04 c1 48 00 	movl   $0x48c1,0x4(%esp)
    1c89:	00 
...
00001ca0 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    1ca9:	c7 44 24 04 ec 48 00 	movl   $0x48ec,0x4(%esp)
    1cb0:	00 
    1cb1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cb8:	e8 53 21 00 00       	call   3e10 <printf>
  unlink("x");
    1cbd:	c7 04 24 79 4b 00 00 	movl   $0x4b79,(%esp)
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1cfb:	74 7b                	je     1d78 <linkunlink+0xd8>
      unlink("x");
    1cfd:	c7 04 24 79 4b 00 00 	movl   $0x4b79,(%esp)
  ...
  for(i = 0; i < 100; i++){
    ...
    1d30:	00 
    1d31:	c7 04 24 79 4b 00 00 	movl   $0x4b79,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1d56:	c7 44 24 04 01 49 00 	movl   $0x4901,0x4(%esp)
    1d5d:	00 
    ...
    1d72:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      link("cat", "x");
    1d78:	c7 44 24 04 79 4b 00 	movl   $0x4b79,0x4(%esp)
    1d7f:	00 
    1d80:	c7 04 24 fd 48 00 00 	movl   $0x48fd,(%esp)
    1d87:	e8 76 1f 00 00       	call   3d02 <link>
    1d8c:	e9 78 ff ff ff       	jmp    1d09 <linkunlink+0x69>
    printf(1, "fork failed\n");
    1d91:	c7 44 24 04 61 51 00 	movl   $0x5161,0x4(%esp)
    1d98:	00 
...
00001db0 <bigdir>:
{
  ...
  close(fd);
    ...
    1e1f:	c7 04 24 1d 49 00 00 	movl   $0x491d,(%esp)
    name[0] = 'x';
  ...
  unlink("bd");
    1e45:	c7 04 24 1d 49 00 00 	movl   $0x491d,(%esp)
  for(i = 0; i < 500; i++){
  ...
  printf(1, "bigdir ok\n");
    1e8d:	c7 44 24 04 5f 49 00 	movl   $0x495f,0x4(%esp)
    1e94:	00 
    ...
    1ea8:	c7 44 24 04 36 49 00 	movl   $0x4936,0x4(%esp)
    1eaf:	00 
    ...
    1ec1:	c7 44 24 04 4a 49 00 	movl   $0x494a,0x4(%esp)
    1ec8:	00 
    ...
    1eda:	c7 44 24 04 20 49 00 	movl   $0x4920,0x4(%esp)
    1ee1:	00 
...
00001f00 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    1f07:	c7 44 24 04 6a 49 00 	movl   $0x496a,0x4(%esp)
    1f0e:	00 
    1f0f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f16:	e8 f5 1e 00 00       	call   3e10 <printf>
  unlink("ff");
    1f1b:	c7 04 24 f3 49 00 00 	movl   $0x49f3,(%esp)
    1f22:	e8 cb 1d 00 00       	call   3cf2 <unlink>
  if(mkdir("dd") != 0){
    1f27:	c7 04 24 90 4a 00 00 	movl   $0x4a90,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1f42:	00 
    1f43:	c7 04 24 c9 49 00 00 	movl   $0x49c9,(%esp)
  ...
  write(fd, "ff", 2);
    ...
    1f60:	00 
    1f61:	c7 44 24 04 f3 49 00 	movl   $0x49f3,0x4(%esp)
    1f68:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1fa8:	00 
    1fa9:	c7 04 24 c6 49 00 00 	movl   $0x49c6,(%esp)
  ...
  write(fd, "FF", 2);
    ...
    1fc6:	00 
    1fc7:	c7 44 24 04 e7 49 00 	movl   $0x49e7,0x4(%esp)
    1fce:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1fe6:	00 
    1fe7:	c7 04 24 ea 49 00 00 	movl   $0x49ea,(%esp)
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    2004:	00 
    2005:	c7 44 24 04 00 8b 00 	movl   $0x8b00,0x4(%esp)
    200c:	00 
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    20d6:	00 
    20d7:	c7 04 24 2a 4a 00 00 	movl   $0x4a2a,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    20f4:	00 
    20f5:	c7 44 24 04 00 8b 00 	movl   $0x8b00,0x4(%esp)
    20fc:	00 
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    211d:	00 
    211e:	c7 04 24 c6 49 00 00 	movl   $0x49c6,(%esp)
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2139:	00 
    213a:	c7 04 24 de 4a 00 00 	movl   $0x4ade,(%esp)
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2155:	00 
    2156:	c7 04 24 03 4b 00 00 	movl   $0x4b03,(%esp)
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2171:	00 
    2172:	c7 04 24 90 4a 00 00 	movl   $0x4a90,(%esp)
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    218d:	00 
    218e:	c7 04 24 90 4a 00 00 	movl   $0x4a90,(%esp)
  ...
  printf(1, "subdir ok\n");
    ...
    231c:	c7 44 24 04 0f 4a 00 	movl   $0x4a0f,0x4(%esp)
    2323:	00 
    ...
    2335:	c7 44 24 04 6a 4a 00 	movl   $0x4a6a,0x4(%esp)
    233c:	00 
    ...
    234e:	c7 44 24 04 35 4a 00 	movl   $0x4a35,0x4(%esp)
    2355:	00 
    ...
    2367:	c7 44 24 04 e7 4a 00 	movl   $0x4ae7,0x4(%esp)
    236e:	00 
    ...
    2380:	c7 44 24 04 cc 54 00 	movl   $0x54cc,0x4(%esp)
    2387:	00 
    ...
    2399:	c7 44 24 04 7b 4b 00 	movl   $0x4b7b,0x4(%esp)
    23a0:	00 
    ...
    23b2:	c7 44 24 04 3c 55 00 	movl   $0x553c,0x4(%esp)
    23b9:	00 
    ...
    23cb:	c7 44 24 04 f6 49 00 	movl   $0x49f6,0x4(%esp)
    23d2:	00 
    ...
    23e4:	c7 44 24 04 cf 49 00 	movl   $0x49cf,0x4(%esp)
    23eb:	00 
    ...
    23fd:	c7 44 24 04 98 4a 00 	movl   $0x4a98,0x4(%esp)
    2404:	00 
    ...
    2416:	c7 44 24 04 84 54 00 	movl   $0x5484,0x4(%esp)
    241d:	00 
    ...
    242f:	c7 44 24 04 18 55 00 	movl   $0x5518,0x4(%esp)
    2436:	00 
    ...
    2448:	c7 44 24 04 f4 54 00 	movl   $0x54f4,0x4(%esp)
    244f:	00 
    ...
    2461:	c7 44 24 04 57 4b 00 	movl   $0x4b57,0x4(%esp)
    2468:	00 
    ...
    247a:	c7 44 24 04 3e 4b 00 	movl   $0x4b3e,0x4(%esp)
    2481:	00 
    ...
    2493:	c7 44 24 04 28 4b 00 	movl   $0x4b28,0x4(%esp)
    249a:	00 
    ...
    24ac:	c7 44 24 04 0c 4b 00 	movl   $0x4b0c,0x4(%esp)
    24b3:	00 
    ...
    24c5:	c7 44 24 04 4d 4a 00 	movl   $0x4a4d,0x4(%esp)
    24cc:	00 
    ...
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    24de:	c7 44 24 04 a8 54 00 	movl   $0x54a8,0x4(%esp)
    24e5:	00 
    ...
    24f7:	c7 44 24 04 ab 49 00 	movl   $0x49ab,0x4(%esp)
    24fe:	00 
    ...
    2510:	c7 44 24 04 5c 54 00 	movl   $0x545c,0x4(%esp)
    2517:	00 
    ...
    2529:	c7 44 24 04 8f 49 00 	movl   $0x498f,0x4(%esp)
    2530:	00 
    ...
    2542:	c7 44 24 04 77 49 00 	movl   $0x4977,0x4(%esp)
    2549:	00 
    ...
    255b:	c7 44 24 04 60 4c 00 	movl   $0x4c60,0x4(%esp)
    2562:	00 
    ...
    2574:	c7 44 24 04 4b 4c 00 	movl   $0x4c4b,0x4(%esp)
    257b:	00 
    ...
    258d:	c7 44 24 04 60 55 00 	movl   $0x5560,0x4(%esp)
    2594:	00 
    ...
    25a6:	c7 44 24 04 36 4c 00 	movl   $0x4c36,0x4(%esp)
    25ad:	00 
    ...
    25bf:	c7 44 24 04 1e 4c 00 	movl   $0x4c1e,0x4(%esp)
    25c6:	00 
    ...
    25d8:	c7 44 24 04 06 4c 00 	movl   $0x4c06,0x4(%esp)
    25df:	00 
    ...
    25f1:	c7 44 24 04 ea 4b 00 	movl   $0x4bea,0x4(%esp)
    25f8:	00 
    ...
    260a:	c7 44 24 04 ce 4b 00 	movl   $0x4bce,0x4(%esp)
    2611:	00 
    ...
    2623:	c7 44 24 04 b1 4b 00 	movl   $0x4bb1,0x4(%esp)
    262a:	00 
    ...
    263c:	c7 44 24 04 96 4b 00 	movl   $0x4b96,0x4(%esp)
    2643:	00 
    ...
    2655:	c7 44 24 04 c3 4a 00 	movl   $0x4ac3,0x4(%esp)
    265c:	00 
    ...
    266e:	c7 44 24 04 ab 4a 00 	movl   $0x4aab,0x4(%esp)
    2675:	00 
    ...
    2695:	bb f3 01 00 00       	mov    $0x1f3,%ebx
{
  ...
  unlink("bigwrite");
    ...
    26e2:	c7 44 24 04 00 8b 00 	movl   $0x8b00,0x4(%esp)
    26e9:	00 
    ...
    26fa:	c7 44 24 04 00 8b 00 	movl   $0x8b00,0x4(%esp)
    2701:	00 
  ...
  printf(1, "bigwrite ok\n");
    ...
    2753:	c7 44 24 04 ad 4c 00 	movl   $0x4cad,0x4(%esp)
    275a:	00 
    ...
    276c:	c7 44 24 04 95 4c 00 	movl   $0x4c95,0x4(%esp)
    2773:	00 
...
00002790 <bigfile>:
{
  ...
  if(fd < 0){
    ...
    27ec:	c7 04 24 00 8b 00 00 	movl   $0x8b00,(%esp)
    27f3:	e8 38 13 00 00       	call   3b30 <memset>
    if(write(fd, buf, 600) != 600){
    27f8:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    27ff:	00 
    2800:	c7 44 24 04 00 8b 00 	movl   $0x8b00,0x4(%esp)
    2807:	00 
  ...
  fd = open("bigfile", 0);
    ...
    2832:	00 
    2833:	c7 04 24 e8 4c 00 00 	movl   $0x4ce8,(%esp)
  ...
  if(fd < 0){
    ...
    285b:	0f be 05 00 8b 00 00 	movsbl 0x8b00,%eax
    2862:	89 fa                	mov    %edi,%edx
    2864:	d1 fa                	sar    %edx
    2866:	39 d0                	cmp    %edx,%eax
    2868:	75 6f                	jne    28d9 <bigfile+0x149>
    286a:	0f be 15 2b 8c 00 00 	movsbl 0x8c2b,%edx
  ...
  for(i = 0; ; i++){
    ...
    2885:	00 
    2886:	c7 44 24 04 00 8b 00 	movl   $0x8b00,0x4(%esp)
    288d:	00 
  ...
  unlink("bigfile");
    28b1:	c7 04 24 e8 4c 00 00 	movl   $0x4ce8,(%esp)
    28b8:	e8 35 14 00 00       	call   3cf2 <unlink>
  printf(1, "bigfile test ok\n");
    28bd:	c7 44 24 04 77 4d 00 	movl   $0x4d77,0x4(%esp)
    28c4:	00 
    ...
    28d9:	c7 44 24 04 44 4d 00 	movl   $0x4d44,0x4(%esp)
    28e0:	00 
    ...
    28f2:	c7 44 24 04 30 4d 00 	movl   $0x4d30,0x4(%esp)
    28f9:	00 
    ...
    290b:	c7 44 24 04 1b 4d 00 	movl   $0x4d1b,0x4(%esp)
    2912:	00 
    ...
    2924:	c7 44 24 04 f0 4c 00 	movl   $0x4cf0,0x4(%esp)
    292b:	00 
    ...
    293d:	c7 44 24 04 06 4d 00 	movl   $0x4d06,0x4(%esp)
    2944:	00 
    ...
    2956:	c7 44 24 04 da 4c 00 	movl   $0x4cda,0x4(%esp)
    295d:	00 
    ...
    296f:	c7 44 24 04 5d 4d 00 	movl   $0x4d5d,0x4(%esp)
    2976:	00 
...
00002990 <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    29d9:	00 
    29da:	c7 04 24 d0 55 00 00 	movl   $0x55d0,(%esp)
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    29fd:	00 
    29fe:	c7 04 24 40 56 00 00 	movl   $0x5640,(%esp)
  ...
  printf(1, "fourteen ok\n");
    ...
    2a50:	c7 44 24 04 97 4d 00 	movl   $0x4d97,0x4(%esp)
    2a57:	00 
    ...
    2a69:	c7 44 24 04 fc 56 00 	movl   $0x56fc,0x4(%esp)
    2a70:	00 
    ...
    2a82:	c7 44 24 04 ac 56 00 	movl   $0x56ac,0x4(%esp)
    2a89:	00 
    ...
    2a9b:	c7 44 24 04 70 56 00 	movl   $0x5670,0x4(%esp)
    2aa2:	00 
    ...
    2ab4:	c7 44 24 04 00 56 00 	movl   $0x5600,0x4(%esp)
    2abb:	00 
    ...
    2acd:	c7 44 24 04 a0 55 00 	movl   $0x55a0,0x4(%esp)
    2ad4:	00 
...
00002af0 <rmdot>:
{
  ...
  printf(1, "rmdot ok\n");
    ...
    2bb8:	c7 44 24 04 f0 4d 00 	movl   $0x4df0,0x4(%esp)
    2bbf:	00 
    ...
    2bd1:	c7 44 24 04 71 4e 00 	movl   $0x4e71,0x4(%esp)
    2bd8:	00 
    ...
    2bea:	c7 44 24 04 59 4e 00 	movl   $0x4e59,0x4(%esp)
    2bf1:	00 
    ...
    printf(1, "unlink dots/. worked!\n");
    2c03:	c7 44 24 04 3a 4e 00 	movl   $0x4e3a,0x4(%esp)
    2c0a:	00 
    ...
    printf(1, "chdir / failed\n");
    2c1c:	c7 44 24 04 6b 42 00 	movl   $0x426b,0x4(%esp)
    2c23:	00 
    ...
    printf(1, "rm .. worked!\n");
    2c35:	c7 44 24 04 24 4e 00 	movl   $0x4e24,0x4(%esp)
    2c3c:	00 
    ...
    printf(1, "rm . worked!\n");
    2c4e:	c7 44 24 04 16 4e 00 	movl   $0x4e16,0x4(%esp)
    2c55:	00 
    ...
    2c67:	c7 44 24 04 03 4e 00 	movl   $0x4e03,0x4(%esp)
    2c6e:	00 
...
00002c80 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    2c87:	c7 44 24 04 90 4e 00 	movl   $0x4e90,0x4(%esp)
    2c8e:	00 
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2ca2:	00 
    2ca3:	c7 04 24 9d 4e 00 00 	movl   $0x4e9d,(%esp)
  ...
  if(chdir("dirfile") == 0){
    2cbf:	c7 04 24 9d 4e 00 00 	movl   $0x4e9d,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    2cda:	00 
    2cdb:	c7 04 24 d6 4e 00 00 	movl   $0x4ed6,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2d6a:	00 
    2d6b:	c7 04 24 96 4a 00 00 	movl   $0x4a96,(%esp)
  ...
  fd = open(".", 0);
    ...
    2d86:	00 
    2d87:	c7 04 24 96 4a 00 00 	movl   $0x4a96,(%esp)
    2d8e:	e8 4f 0f 00 00       	call   3ce2 <open>
  if(write(fd, "x", 1) > 0){
    2d93:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    2d9a:	00 
    2d9b:	c7 44 24 04 79 4b 00 	movl   $0x4b79,0x4(%esp)
    2da2:	00 
  ...
  printf(1, "dir vs file OK\n");
    2db9:	c7 44 24 04 6d 4f 00 	movl   $0x4f6d,0x4(%esp)
    2dc0:	00 
    ...
    2dd3:	c7 44 24 04 e1 4e 00 	movl   $0x4ee1,0x4(%esp)
    2dda:	00 
    ...
    2dec:	c7 44 24 04 bc 4e 00 	movl   $0x4ebc,0x4(%esp)
    2df3:	00 
    ...
    2e05:	c7 44 24 04 a5 4e 00 	movl   $0x4ea5,0x4(%esp)
    2e0c:	00 
    ...
    2e1e:	c7 44 24 04 59 4f 00 	movl   $0x4f59,0x4(%esp)
    2e25:	00 
    ...
    2e37:	c7 44 24 04 50 57 00 	movl   $0x5750,0x4(%esp)
    2e3e:	00 
    ...
    2e50:	c7 44 24 04 41 4f 00 	movl   $0x4f41,0x4(%esp)
    2e57:	00 
    ...
    2e69:	c7 44 24 04 30 57 00 	movl   $0x5730,0x4(%esp)
    2e70:	00 
    ...
    2e82:	c7 44 24 04 1c 4f 00 	movl   $0x4f1c,0x4(%esp)
    2e89:	00 
    ...
    2e9b:	c7 44 24 04 ff 4e 00 	movl   $0x4eff,0x4(%esp)
    2ea2:	00 
    ...
    2ec4:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2f4f:	00 
    2f50:	c7 04 24 78 4b 00 00 	movl   $0x4b78,(%esp)
  ...
  printf(1, "empty file name OK\n");
    ...
    2fa3:	c7 44 24 04 94 4f 00 	movl   $0x4f94,0x4(%esp)
    2faa:	00 
    ...
    2fbc:	c7 44 24 04 a8 4f 00 	movl   $0x4fa8,0x4(%esp)
    2fc3:	00 
    ...
    2fe4:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    2fe9:	c7 44 24 04 d0 4f 00 	movl   $0x4fd0,0x4(%esp)
    2ff0:	00 
  ...
  printf(1, "fork test OK\n");
    3042:	c7 44 24 04 02 50 00 	movl   $0x5002,0x4(%esp)
    3049:	00 
    ...
    3060:	c7 44 24 04 70 57 00 	movl   $0x5770,0x4(%esp)
    3067:	00 
    ...
    3079:	c7 44 24 04 db 4f 00 	movl   $0x4fdb,0x4(%esp)
    3080:	00 
    ...
    3092:	c7 44 24 04 ef 4f 00 	movl   $0x4fef,0x4(%esp)
    3099:	00 
    ...
    30b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "sbrk test\n");
    30bb:	a1 24 63 00 00       	mov    0x6324,%eax
    30c0:	c7 44 24 04 10 50 00 	movl   $0x5010,0x4(%esp)
    30c7:	00 
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    331a:	a1 24 63 00 00       	mov    0x6324,%eax
    331f:	c7 44 24 04 b8 50 00 	movl   $0x50b8,0x4(%esp)
    3326:	00 
    ...
    335c:	00 
    335d:	c7 44 24 04 79 4b 00 	movl   $0x4b79,0x4(%esp)
    3364:	00 
    ...
    3382:	a1 24 63 00 00       	mov    0x6324,%eax
    3387:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
    338b:	89 74 24 08          	mov    %esi,0x8(%esp)
    338f:	c7 44 24 04 1b 50 00 	movl   $0x501b,0x4(%esp)
    3396:	00 
    ...
    33a4:	a1 24 63 00 00       	mov    0x6324,%eax
    33a9:	c7 44 24 04 9d 50 00 	movl   $0x509d,0x4(%esp)
    33b0:	00 
    ...
    printf(1, "pipe() failed\n");
    33be:	c7 44 24 04 59 45 00 	movl   $0x4559,0x4(%esp)
    33c5:	00 
    ...
    33de:	c7 44 24 04 84 50 00 	movl   $0x5084,0x4(%esp)
    33e5:	00 
    33e6:	89 44 24 0c          	mov    %eax,0xc(%esp)
    33ea:	a1 24 63 00 00       	mov    0x6324,%eax
    ...
    33ff:	e8 9e 08 00 00       	call   3ca2 <exit>
      printf(stdout, "fork failed\n");
    3404:	a1 24 63 00 00       	mov    0x6324,%eax
    3409:	c7 44 24 04 61 51 00 	movl   $0x5161,0x4(%esp)
    3410:	00 
    ...
    3422:	a1 24 63 00 00       	mov    0x6324,%eax
    3427:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    342b:	c7 44 24 04 64 58 00 	movl   $0x5864,0x4(%esp)
    3432:	00 
    ...
    3440:	a1 24 63 00 00       	mov    0x6324,%eax
    3445:	c7 44 24 04 34 58 00 	movl   $0x5834,0x4(%esp)
    344c:	00 
    ...
    345a:	a1 24 63 00 00       	mov    0x6324,%eax
    345f:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
    3463:	89 74 24 08          	mov    %esi,0x8(%esp)
    3467:	c7 44 24 04 0c 58 00 	movl   $0x580c,0x4(%esp)
    346e:	00 
    ...
    3480:	a1 24 63 00 00       	mov    0x6324,%eax
    3485:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    3489:	c7 44 24 04 d4 57 00 	movl   $0x57d4,0x4(%esp)
    3490:	00 
    ...
    349e:	a1 24 63 00 00       	mov    0x6324,%eax
    34a3:	c7 44 24 04 69 50 00 	movl   $0x5069,0x4(%esp)
    34aa:	00 
    ...
    34b8:	a1 24 63 00 00       	mov    0x6324,%eax
    34bd:	c7 44 24 04 94 57 00 	movl   $0x5794,0x4(%esp)
    34c4:	00 
    ...
    34d2:	a1 24 63 00 00       	mov    0x6324,%eax
    34d7:	c7 44 24 04 4d 50 00 	movl   $0x504d,0x4(%esp)
    34de:	00 
    ...
    34ec:	a1 24 63 00 00       	mov    0x6324,%eax
    34f1:	c7 44 24 04 36 50 00 	movl   $0x5036,0x4(%esp)
    34f8:	00 
    ...
    3525:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(stdout, "validate test\n");
    352a:	a1 24 63 00 00       	mov    0x6324,%eax
    352f:	c7 44 24 04 c6 50 00 	movl   $0x50c6,0x4(%esp)
    3536:	00 
    ...
    3574:	c7 04 24 d5 50 00 00 	movl   $0x50d5,(%esp)
  ...
  printf(stdout, "validate ok\n");
    3593:	a1 24 63 00 00       	mov    0x6324,%eax
    3598:	c7 44 24 04 f9 50 00 	movl   $0x50f9,0x4(%esp)
    359f:	00 
    ...
    35af:	a1 24 63 00 00       	mov    0x6324,%eax
    35b4:	c7 44 24 04 e0 50 00 	movl   $0x50e0,0x4(%esp)
    35bb:	00 
...
000035d0 <bsstest>:
{
  ...
  printf(stdout, "bss test ok\n");
    3613:	a1 24 63 00 00       	mov    0x6324,%eax
    3618:	c7 44 24 04 21 51 00 	movl   $0x5121,0x4(%esp)
    361f:	00 
    ...
    362a:	a1 24 63 00 00       	mov    0x6324,%eax
    362f:	c7 44 24 04 10 51 00 	movl   $0x5110,0x4(%esp)
    3636:	00 
...
00003650 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    3656:	c7 04 24 2e 51 00 00 	movl   $0x512e,(%esp)
  ...
  fd = open("bigarg-ok", 0);
    ...
    3682:	00 
    3683:	c7 04 24 2e 51 00 00 	movl   $0x512e,(%esp)
  ...
  unlink("bigarg-ok");
    369f:	c7 04 24 2e 51 00 00 	movl   $0x512e,(%esp)
    ...
    36b0:	c7 04 85 40 63 00 00 	movl   $0x5888,0x6340(,%eax,4)
    36b7:	88 58 00 00 
    ...
    36c3:	a1 24 63 00 00       	mov    0x6324,%eax
    36c8:	c7 44 24 04 38 51 00 	movl   $0x5138,0x4(%esp)
    36cf:	00 
    args[MAXARG-1] = 0;
    36d0:	c7 05 bc 63 00 00 00 	movl   $0x0,0x63bc
    36d7:	00 00 00 
    printf(stdout, "bigarg test\n");
    36da:	89 04 24             	mov    %eax,(%esp)
    36dd:	e8 2e 07 00 00       	call   3e10 <printf>
    exec("echo", args);
    36e2:	c7 44 24 04 40 63 00 	movl   $0x6340,0x4(%esp)
    36e9:	00 
    36ea:	c7 04 24 05 43 00 00 	movl   $0x4305,(%esp)
    36f1:	e8 e4 05 00 00       	call   3cda <exec>
    printf(stdout, "bigarg test ok\n");
    36f6:	a1 24 63 00 00       	mov    0x6324,%eax
    36fb:	c7 44 24 04 45 51 00 	movl   $0x5145,0x4(%esp)
    3702:	00 
    ...
    3712:	00 
    3713:	c7 04 24 2e 51 00 00 	movl   $0x512e,(%esp)
    ...
    372c:	a1 24 63 00 00       	mov    0x6324,%eax
    3731:	c7 44 24 04 6e 51 00 	movl   $0x516e,0x4(%esp)
    3738:	00 
    ...
    3746:	a1 24 63 00 00       	mov    0x6324,%eax
    374b:	c7 44 24 04 55 51 00 	movl   $0x5155,0x4(%esp)
    3752:	00 
    ...
    3766:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    376b:	c7 44 24 04 83 51 00 	movl   $0x5183,0x4(%esp)
    3772:	00 
    ...
    printf(1, "writing %s\n", name);
    3790:	c7 44 24 04 90 51 00 	movl   $0x5190,0x4(%esp)
    3797:	00 
    ...
    3849:	00 
    384a:	c7 44 24 04 00 8b 00 	movl   $0x8b00,0x4(%esp)
    3851:	00 
    ...
    3865:	c7 44 24 04 ac 51 00 	movl   $0x51ac,0x4(%esp)
    386c:	00 
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3894:	c7 44 24 04 9c 51 00 	movl   $0x519c,0x4(%esp)
    389b:	00 
  ...
  printf(1, "fsfull test finished\n");
    3941:	c7 44 24 04 bc 51 00 	movl   $0x51bc,0x4(%esp)
    3948:	00 
...
00003960 <uio>:
{
  ...
  printf(1, "uio test\n");
    3966:	c7 44 24 04 d2 51 00 	movl   $0x51d2,0x4(%esp)
    396d:	00 
  ...
  printf(1, "uio test done\n");
    398a:	c7 44 24 04 dc 51 00 	movl   $0x51dc,0x4(%esp)
    3991:	00 
    ...
    39ae:	c7 44 24 04 68 59 00 	movl   $0x5968,0x4(%esp)
    39b5:	00 
    ...
    printf (1, "fork failed\n");
    39c7:	c7 44 24 04 61 51 00 	movl   $0x5161,0x4(%esp)
    39ce:	00 
...
000039e0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    39ee:	00 
    39ef:	c7 04 24 eb 51 00 00 	movl   $0x51eb,(%esp)
  ...
  printf(1, "arg test passed\n");
    3a2c:	c7 44 24 04 fd 51 00 	movl   $0x51fd,0x4(%esp)
    3a33:	00 
    ...
    3a46:	c7 44 24 04 f0 51 00 	movl   $0x51f0,0x4(%esp)
    3a4d:	00 
...
00003a60 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3a60:	69 05 20 63 00 00 0d 	imul   $0x19660d,0x6320,%eax
    3a67:	66 19 00 
{
    3a6a:	55                   	push   %ebp
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    3a73:	a3 20 63 00 00       	mov    %eax,0x6320
}
    3a78:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    3da9:	0f b6 92 bf 59 00 00 	movzbl 0x59bf(%edx),%edx
  }while((x /= base) != 0);
    ...
    3e1e:	8d 45 10             	lea    0x10(%ebp),%eax
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3f3f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
    3f41:	b8 b8 59 00 00       	mov    $0x59b8,%eax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4001:	a1 c0 63 00 00       	mov    0x63c0,%eax
{
  ...
  freep = p;
    4049:	a3 c0 63 00 00       	mov    %eax,0x63c0
}
    404e:	5b                   	pop    %ebx
    404f:	5e                   	pop    %esi
    4050:	5f                   	pop    %edi
  ...
  freep = p;
    4072:	a3 c0 63 00 00       	mov    %eax,0x63c0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    409c:	8b 1d c0 63 00 00    	mov    0x63c0,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    40db:	3b 15 c0 63 00 00    	cmp    0x63c0,%edx
  ...
  return freep;
    4112:	8b 15 c0 63 00 00    	mov    0x63c0,%edx
    ...
    4134:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    4137:	89 15 c0 63 00 00    	mov    %edx,0x63c0
      return (void*)(p + 1);
    ...
    base.s.ptr = freep = prevp = &base;
    414e:	c7 05 c0 63 00 00 c4 	movl   $0x63c4,0x63c0
    4155:	63 00 00 
    base.s.size = 0;
    4158:	ba c4 63 00 00       	mov    $0x63c4,%edx
    base.s.ptr = freep = prevp = &base;
    415d:	c7 05 c4 63 00 00 c4 	movl   $0x63c4,0x63c4
    4164:	63 00 00 
    base.s.size = 0;
    4167:	c7 05 c8 63 00 00 00 	movl   $0x0,0x63c8
    416e:	00 00 00 
...
void thread_create(void *(*start_routine)(void*), void *arg){
    ...
    4183:	53                   	push   %ebx
    4184:	83 ec 14             	sub    $0x14,%esp

  void *stack = malloc(PGSIZE*2);//allocate a block of memory for stack of thread
    4187:	c7 04 24 00 20 00 00 	movl   $0x2000,(%esp)
    418e:	e8 fd fe ff ff       	call   4090 <malloc>
    4193:	89 c3                	mov    %eax,%ebx
  if((uint)stack % PGSIZE)
    4195:	25 ff 0f 00 00       	and    $0xfff,%eax
    419a:	74 08                	je     41a4 <thread_create+0x24>
      stack = stack + (PGSIZE - (uint)stack % PGSIZE);
    419c:	29 c3                	sub    %eax,%ebx
    419e:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  int id;
  id = clone(stack, PGSIZE*2);
    41a4:	c7 44 24 04 00 20 00 	movl   $0x2000,0x4(%esp)
    41ab:	00 
    41ac:	89 1c 24             	mov    %ebx,(%esp)
    41af:	e8 a6 fb ff ff       	call   3d5a <clone>
  // id == 0 means this process is a thread
  if(id == 0){
    41b4:	85 c0                	test   %eax,%eax
    41b6:	74 06                	je     41be <thread_create+0x3e>
    (*start_routine)(arg);
    free(stack);
    exit();
  }
    ...
    41b8:	83 c4 14             	add    $0x14,%esp
    41bb:	5b                   	pop    %ebx
    41bc:	5d                   	pop    %ebp
    41bd:	c3                   	ret    
    (*start_routine)(arg);
    41be:	8b 45 0c             	mov    0xc(%ebp),%eax
    41c1:	89 04 24             	mov    %eax,(%esp)
    41c4:	ff 55 08             	call   *0x8(%ebp)
    free(stack);
    41c7:	89 1c 24             	mov    %ebx,(%esp)
    41ca:	e8 31 fe ff ff       	call   4000 <free>
    exit();
    41cf:	e8 ce fa ff ff       	call   3ca2 <exit>
    41d4:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    41da:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
...
void lock_init(struct lock_t *lk){
    ...
    41e6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
    41ec:	5d                   	pop    %ebp
    41ed:	c3                   	ret    
    41ee:	66 90                	xchg   %ax,%ax

000041f0 <lock_acquire>:
...
00004210 <lock_release>:

void lock_release(struct lock_t *lk){
    4210:	55                   	push   %ebp
    4211:	31 c0                	xor    %eax,%eax
    4213:	89 e5                	mov    %esp,%ebp
    4215:	8b 55 08             	mov    0x8(%ebp),%edx
    4218:	f0 87 02             	lock xchg %eax,(%edx)
  xchg(&lk->locked, 0);
    421b:	5d                   	pop    %ebp
    421c:	c3                   	ret    

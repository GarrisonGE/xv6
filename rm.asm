   ...
   5:	be 01 00 00 00       	mov    $0x1,%esi
{
  ...
  3f:	c7 44 24 04 31 08 00 	movl   $0x831,0x4(%esp)
  46:	00 
  ...
  57:	eb df                	jmp    38 <main+0x38>
    printf(2, "Usage: rm files...\n");
  59:	c7 44 24 04 1d 08 00 	movl   $0x81d,0x4(%esp)
  60:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a9:	0f b6 92 51 08 00 00 	movzbl 0x851(%edx),%edx
  }while((x /= base) != 0);
 ...
 41e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 53f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 541:	b8 4a 08 00 00       	mov    $0x84a,%eax
...
free(void *ap)
{
 ...
 601:	a1 58 0b 00 00       	mov    0xb58,%eax
{
 ...
 647:	89 10                	mov    %edx,(%eax)
  freep = p;
 649:	a3 58 0b 00 00       	mov    %eax,0xb58
}
 64e:	5b                   	pop    %ebx
 64f:	5e                   	pop    %esi
 650:	5f                   	pop    %edi
 ...
 66f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 672:	a3 58 0b 00 00       	mov    %eax,0xb58
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 1d 58 0b 00 00    	mov    0xb58,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6d9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6db:	3b 15 58 0b 00 00    	cmp    0xb58,%edx
 ...
 70d:	e8 ee fe ff ff       	call   600 <free>
  return freep;
 712:	8b 15 58 0b 00 00    	mov    0xb58,%edx
 ...
 734:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 737:	89 15 58 0b 00 00    	mov    %edx,0xb58
      return (void*)(p + 1);
 ...
 74c:	eb e9                	jmp    737 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 74e:	c7 05 58 0b 00 00 5c 	movl   $0xb5c,0xb58
 755:	0b 00 00 
    base.s.size = 0;
 758:	ba 5c 0b 00 00       	mov    $0xb5c,%edx
    base.s.ptr = freep = prevp = &base;
 75d:	c7 05 5c 0b 00 00 5c 	movl   $0xb5c,0xb5c
 764:	0b 00 00 
    base.s.size = 0;
 767:	c7 05 60 0b 00 00 00 	movl   $0x0,0xb60
 76e:	00 00 00 

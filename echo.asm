...
main(int argc, char *argv[])
{
  ...
  20:	c7 44 24 0c 1d 08 00 	movl   $0x81d,0xc(%esp)
  27:	00 
  28:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  2c:	c7 44 24 04 1f 08 00 	movl   $0x81f,0x4(%esp)
  33:	00 
  ...
  4b:	c7 44 24 0c 24 08 00 	movl   $0x824,0xc(%esp)
  52:	00 
  53:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  57:	c7 44 24 04 1f 08 00 	movl   $0x81f,0x4(%esp)
  5e:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a9:	0f b6 92 2d 08 00 00 	movzbl 0x82d(%edx),%edx
  }while((x /= base) != 0);
 ...
 41e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 53f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 541:	b8 26 08 00 00       	mov    $0x826,%eax
 ...
 601:	a1 30 0b 00 00       	mov    0xb30,%eax
{
 ...
 647:	89 10                	mov    %edx,(%eax)
  freep = p;
 649:	a3 30 0b 00 00       	mov    %eax,0xb30
}
 64e:	5b                   	pop    %ebx
 64f:	5e                   	pop    %esi
 650:	5f                   	pop    %edi
 ...
 66f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 672:	a3 30 0b 00 00       	mov    %eax,0xb30
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 1d 30 0b 00 00    	mov    0xb30,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6d9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6db:	3b 15 30 0b 00 00    	cmp    0xb30,%edx
 ...
 70d:	e8 ee fe ff ff       	call   600 <free>
  return freep;
 712:	8b 15 30 0b 00 00    	mov    0xb30,%edx
 ...
 734:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 737:	89 15 30 0b 00 00    	mov    %edx,0xb30
      return (void*)(p + 1);
 ...
 74c:	eb e9                	jmp    737 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 74e:	c7 05 30 0b 00 00 34 	movl   $0xb34,0xb30
 755:	0b 00 00 
    base.s.size = 0;
 758:	ba 34 0b 00 00       	mov    $0xb34,%edx
    base.s.ptr = freep = prevp = &base;
 75d:	c7 05 34 0b 00 00 34 	movl   $0xb34,0xb34
 764:	0b 00 00 
    base.s.size = 0;
 767:	c7 05 38 0b 00 00 00 	movl   $0x0,0xb38
 76e:	00 00 00 
...
void thread_create(void *(*start_routine)(void*), void *arg){
 ...
 783:	53                   	push   %ebx
 784:	83 ec 14             	sub    $0x14,%esp

  void *stack = malloc(PGSIZE*2);//allocate a block of memory for stack of thread
 787:	c7 04 24 00 20 00 00 	movl   $0x2000,(%esp)
 78e:	e8 fd fe ff ff       	call   690 <malloc>
 793:	89 c3                	mov    %eax,%ebx
  if((uint)stack % PGSIZE)
 795:	25 ff 0f 00 00       	and    $0xfff,%eax
 79a:	74 08                	je     7a4 <thread_create+0x24>
      stack = stack + (PGSIZE - (uint)stack % PGSIZE);
 79c:	29 c3                	sub    %eax,%ebx
 79e:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  int id;
  id = clone(stack, PGSIZE*2);
 7a4:	c7 44 24 04 00 20 00 	movl   $0x2000,0x4(%esp)
 7ab:	00 
 7ac:	89 1c 24             	mov    %ebx,(%esp)
 7af:	e8 a6 fb ff ff       	call   35a <clone>
  // id == 0 means this process is a thread
  if(id == 0){
 7b4:	85 c0                	test   %eax,%eax
 7b6:	74 06                	je     7be <thread_create+0x3e>
    (*start_routine)(arg);
    free(stack);
    exit();
  }
 ...
 7c4:	ff 55 08             	call   *0x8(%ebp)
    free(stack);
 7c7:	89 1c 24             	mov    %ebx,(%esp)
 7ca:	e8 31 fe ff ff       	call   600 <free>
    exit();
 7cf:	e8 ce fa ff ff       	call   2a2 <exit>
...
void lock_init(struct lock_t *lk){
 ...
 7e6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 7ec:	5d                   	pop    %ebp
 7ed:	c3                   	ret    
 7ee:	66 90                	xchg   %ax,%ax

000007f0 <lock_acquire>:
...
void lock_release(struct lock_t *lk){
 ...
 818:	f0 87 02             	lock xchg %eax,(%edx)
  xchg(&lk->locked, 0);
 81b:	5d                   	pop    %ebp
 81c:	c3                   	ret    

...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      20:	00 
      21:	c7 04 24 01 14 00 00 	movl   $0x1401,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
      ...
      5d:	00 
      5e:	c7 04 24 80 1a 00 00 	movl   $0x1a80,(%esp)
      65:	e8 96 00 00 00       	call   100 <getcmd>
      6a:	85 c0                	test   %eax,%eax
      6c:	78 2f                	js     9d <main+0x9d>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      6e:	80 3d 80 1a 00 00 63 	cmpb   $0x63,0x1a80
      75:	75 d1                	jne    48 <main+0x48>
      77:	80 3d 81 1a 00 00 64 	cmpb   $0x64,0x1a81
    ...
    if(fork1() == 0)
      ...
      runcmd(parsecmd(buf));
      89:	c7 04 24 80 1a 00 00 	movl   $0x1a80,(%esp)
  ...
  exit();
      ...
      buf[strlen(buf)-1] = 0;  // chop \n
      a2:	c7 04 24 80 1a 00 00 	movl   $0x1a80,(%esp)
      a9:	e8 92 0b 00 00       	call   c40 <strlen>
      if(chdir(buf+3) < 0)
      ae:	c7 04 24 83 1a 00 00 	movl   $0x1a83,(%esp)
      buf[strlen(buf)-1] = 0;  // chop \n
      b5:	c6 80 7f 1a 00 00 00 	movb   $0x0,0x1a7f(%eax)
      if(chdir(buf+3) < 0)
      bc:	e8 91 0d 00 00       	call   e52 <chdir>
      c1:	85 c0                	test   %eax,%eax
      c3:	79 91                	jns    56 <main+0x56>
        printf(2, "cannot cd %s\n", buf+3);
      c5:	c7 44 24 08 83 1a 00 	movl   $0x1a83,0x8(%esp)
      cc:	00 
      cd:	c7 44 24 04 09 14 00 	movl   $0x1409,0x4(%esp)
      d4:	00 
...
00000100 <getcmd>:
{
  ...
  printf(2, "$ ");
     10e:	c7 44 24 04 60 13 00 	movl   $0x1360,0x4(%esp)
     115:	00 
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     169:	c7 44 24 04 fd 13 00 	movl   $0x13fd,0x4(%esp)
     170:	00 
...
fork1(void)
{
  ...
  return pid;
     ...
     1a1:	c3                   	ret    
    panic("fork");
     1a2:	c7 04 24 63 13 00 00 	movl   $0x1363,(%esp)
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1c9:	ff 24 85 18 14 00 00 	jmp    *0x1418(,%eax,4)
    if(pipe(p) < 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     24b:	c7 44 24 04 6f 13 00 	movl   $0x136f,0x4(%esp)
     252:	00 
    ...
    panic("runcmd");
     2ae:	c7 04 24 68 13 00 00 	movl   $0x1368,(%esp)
     2b5:	e8 a6 fe ff ff       	call   160 <panic>
      panic("pipe");
     2ba:	c7 04 24 8f 13 00 00 	movl   $0x138f,(%esp)
     2c1:	e8 9a fe ff ff       	call   160 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     2c6:	8b 43 08             	mov    0x8(%ebx),%eax
     2c9:	c7 44 24 04 7f 13 00 	movl   $0x137f,0x4(%esp)
     2d0:	00 
     ...
     4f9:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     51a:	c7 04 24 70 1a 00 00 	movl   $0x1a70,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     56a:	c7 04 24 70 1a 00 00 	movl   $0x1a70,(%esp)
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     5bb:	c7 04 24 68 1a 00 00 	movl   $0x1a68,(%esp)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     5dd:	c7 04 24 70 1a 00 00 	movl   $0x1a70,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     652:	c7 04 24 70 1a 00 00 	movl   $0x1a70,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     6a0:	c7 44 24 08 b1 13 00 	movl   $0x13b1,0x8(%esp)
     6a7:	00 
  ...
  return cmd;
     ...
     762:	c3                   	ret    
      panic("missing file for redirection");
     763:	c7 04 24 94 13 00 00 	movl   $0x1394,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     77f:	c7 44 24 08 b4 13 00 	movl   $0x13b4,0x8(%esp)
     786:	00 
  ...
  while(!peek(ps, es, "|)&;")){
     7de:	c7 44 24 08 cb 13 00 	movl   $0x13cb,0x8(%esp)
     7e5:	00 
    ...
    if(argc >= MAXARGS)
     ...
     82f:	75 97                	jne    7c8 <parseexec+0x58>
      panic("too many args");
     831:	c7 04 24 bd 13 00 00 	movl   $0x13bd,(%esp)
  ...
  return ret;
     ...
     879:	c3                   	ret    
      panic("syntax");
     87a:	c7 04 24 b6 13 00 00 	movl   $0x13b6,(%esp)
...
00000890 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     8ab:	c7 44 24 08 d0 13 00 	movl   $0x13d0,0x8(%esp)
     8b2:	00 
...
00000910 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     956:	c7 44 24 08 d2 13 00 	movl   $0x13d2,0x8(%esp)
     95d:	00 
  ...
  if(peek(ps, es, ";")){
     96e:	c7 44 24 08 ce 13 00 	movl   $0x13ce,0x8(%esp)
     975:	00 
...
000009d0 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     9df:	c7 44 24 08 b4 13 00 	movl   $0x13b4,0x8(%esp)
     9e6:	00 
  ...
  if(!peek(ps, es, ")"))
     a1f:	c7 44 24 08 f0 13 00 	movl   $0x13f0,0x8(%esp)
     a26:	00 
  ...
  cmd = parseredirs(cmd, ps, es);
     ...
     a6c:	c3                   	ret    
    panic("parseblock");
     a6d:	c7 04 24 d4 13 00 00 	movl   $0x13d4,(%esp)
     a74:	e8 e7 f6 ff ff       	call   160 <panic>
    panic("syntax - missing )");
     a79:	c7 04 24 df 13 00 00 	movl   $0x13df,(%esp)
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     aa9:	ff 24 85 30 14 00 00 	jmp    *0x1430(,%eax,4)
...
00000b40 <parsecmd>:
{
  ...
  peek(&s, es, "");
     b64:	c7 44 24 08 7e 13 00 	movl   $0x137e,0x8(%esp)
     b6b:	00 
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     b99:	c7 44 24 04 f2 13 00 	movl   $0x13f2,0x4(%esp)
     ba0:	00 
     ba1:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     ba8:	e8 a3 03 00 00       	call   f50 <printf>
    panic("syntax");
     bad:	c7 04 24 b6 13 00 00 	movl   $0x13b6,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ee9:	0f b6 92 4f 14 00 00 	movzbl 0x144f(%edx),%edx
  }while((x /= base) != 0);
     ...
     f5e:	8d 45 10             	lea    0x10(%ebp),%eax
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    107f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
    1081:	b8 48 14 00 00       	mov    $0x1448,%eax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1141:	a1 e4 1a 00 00       	mov    0x1ae4,%eax
{
  ...
  freep = p;
    1189:	a3 e4 1a 00 00       	mov    %eax,0x1ae4
}
    118e:	5b                   	pop    %ebx
    118f:	5e                   	pop    %esi
    1190:	5f                   	pop    %edi
  ...
  freep = p;
    11b2:	a3 e4 1a 00 00       	mov    %eax,0x1ae4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    11dc:	8b 1d e4 1a 00 00    	mov    0x1ae4,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    121b:	3b 15 e4 1a 00 00    	cmp    0x1ae4,%edx
  ...
  return freep;
    1252:	8b 15 e4 1a 00 00    	mov    0x1ae4,%edx
    ...
    1274:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    1277:	89 15 e4 1a 00 00    	mov    %edx,0x1ae4
      return (void*)(p + 1);
    ...
    base.s.ptr = freep = prevp = &base;
    128e:	c7 05 e4 1a 00 00 e8 	movl   $0x1ae8,0x1ae4
    1295:	1a 00 00 
    base.s.size = 0;
    1298:	ba e8 1a 00 00       	mov    $0x1ae8,%edx
    base.s.ptr = freep = prevp = &base;
    129d:	c7 05 e8 1a 00 00 e8 	movl   $0x1ae8,0x1ae8
    12a4:	1a 00 00 
    base.s.size = 0;
    12a7:	c7 05 ec 1a 00 00 00 	movl   $0x0,0x1aec
    12ae:	00 00 00 
...
void thread_create(void *(*start_routine)(void*), void *arg){
  ...
  void *stack = malloc(PGSIZE*2);//allocate a block of memory for stack of thread
    12c7:	c7 04 24 00 20 00 00 	movl   $0x2000,(%esp)
    12ce:	e8 fd fe ff ff       	call   11d0 <malloc>
    12d3:	89 c3                	mov    %eax,%ebx
  if((uint)stack % PGSIZE)
    12d5:	25 ff 0f 00 00       	and    $0xfff,%eax
    12da:	74 08                	je     12e4 <thread_create+0x24>
      stack = stack + (PGSIZE - (uint)stack % PGSIZE);
    12dc:	29 c3                	sub    %eax,%ebx
    12de:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  int id;
  id = clone(stack, PGSIZE*2);
    12e4:	c7 44 24 04 00 20 00 	movl   $0x2000,0x4(%esp)
    12eb:	00 
    12ec:	89 1c 24             	mov    %ebx,(%esp)
    12ef:	e8 a6 fb ff ff       	call   e9a <clone>
  // id == 0 means this process is a thread
  if(id == 0){
    12f4:	85 c0                	test   %eax,%eax
    12f6:	74 06                	je     12fe <thread_create+0x3e>
    (*start_routine)(arg);
    free(stack);
    exit();
  }
    ...
    1304:	ff 55 08             	call   *0x8(%ebp)
    free(stack);
    1307:	89 1c 24             	mov    %ebx,(%esp)
    130a:	e8 31 fe ff ff       	call   1140 <free>
    exit();
    130f:	e8 ce fa ff ff       	call   de2 <exit>
...
void lock_init(struct lock_t *lk){
    ...
    1326:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
    132c:	5d                   	pop    %ebp
    132d:	c3                   	ret    
